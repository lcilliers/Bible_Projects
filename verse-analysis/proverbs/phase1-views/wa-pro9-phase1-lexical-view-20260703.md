...
- **hewn** `H2672` [2] **role=standalone** — sense=hewn; type=action; operation=hewn
- **seven** `H7651` [2] **role=standalone** — sense=seven; type=quality
- **pillars** `H5982` [2] **role=standalone** — sense=pillars; type=status

## Pro 9:2

- **slaughtered** `H2873` [2] **role=standalone** — sense=slaughtered; type=action; operation=slaughtered
- **beasts** `H2874` [2] **role=standalone** — sense=beasts; type=status
- **mixed** `H4537` [2] **role=standalone** — sense=mixed; type=action; operation=mixed
- **wine** `H3196` [2] **role=standalone** — sense=wine; type=status
- **set** `H6186` [1/M26] **role=characteristic** — sense=set; type=action; operation=set
...
- **turn in** `H5493` [1/M30] **role=characteristic** — sense=turn in; type=action; operation=turn in
...
- **bread** `H3899` [2] **role=process-qualifier** — sense=bread; type=status; operation=(qualifies) eat; manner=manner-of eat; coupling=welds eat
- **drink** `H8354` [2] **role=standalone** — sense=drink; type=action; operation=drink
- **wine** `H3196` [2] **role=process-qualifier** — sense=wine; type=status; operation=(qualifies) drink; manner=manner-of drink; coupling=welds drink
- **mixed** `H4537` [2] **role=standalone** — sense=mixed; type=action; operation=mixed
...
- **corrects** `H3256` [2] **role=standalone** — sense=corrects; type=action; operation=corrects
- **scoffer** `H3887` [2] **role=standalone** — sense=scoffer; type=quality
- **gets himself** `H3947` [2] **role=standalone** — sense=gets himself; type=action; operation=gets himself
- **abuse** `H7036` [1/M07] **role=process-qualifier** — sense=abuse; type=status; operation=(qualifies) gets himself; manner=manner-of gets himself; coupling=welds gets himself
- **reproves** `H3198` [2] **role=standalone** — sense=reproves; type=action; operation=reproves
- **wicked** `H7563` [1/M10] **role=process-qualifier** — sense=wicked; type=status; operation=(qualifies) reproves; manner=manner-of reproves; coupling=welds reproves
- **incurs injury** `H3971` [2] **role=standalone** — sense=incurs injury; type=status

## Pro 9:8

- **reprove** `H3198` [2] **role=standalone** — sense=reprove; type=action; operation=reprove; prohibition=forbidden (neg particle)
...
- **insight** `H0998` [1/M15] **role=characteristic** — sense=insight; type=status; bearer=Lord; discovery=bearer unreliable (nearest-proper heuristic; subject-agreement not parsed)
...
- **wise** `H2449` [2] **role=standalone** — sense=wise; type=action; operation=wise
- **scoff** `H3887` [2] **role=standalone** — sense=scoff; type=action; operation=scoff
- **alone** `H0905` [2] **role=process-qualifier** — sense=alone; type=status; operation=(qualifies) scoff; manner=manner-of scoff; coupling=welds scoff
...
- **calling** `H7121` [1/M37] **role=characteristic** — sense=calling; type=action; operation=calling
- **pass by** `H5674` [2] **role=standalone** — sense=pass by; type=action; operation=pass by
