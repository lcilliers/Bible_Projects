...
- **established** `H3559` [2] **role=standalone** — sense=established; type=action; operation=established; prohibition=forbidden (neg particle)
- **wickedness** `H7562` [2] **role=process-qualifier** — sense=wickedness; type=status; operation=(qualifies) established; manner=manner-of established; coupling=welds established; prohibition=forbidden (neg particle)
- **root** `H8328` [2] **role=standalone** — sense=root; type=status
...
- **counsels** `H8458` [1/M17] **role=characteristic** — sense=counsels; type=status
...
- **wicked** `H7563` [1/M10] **role=characteristic** — sense=wicked; type=status
- **covets** `H2530` [1/M28] **role=characteristic** — sense=covets; type=action; operation=covets
- **spoil** `H4685` [2] **role=standalone** — sense=spoil; type=status
- **evildoers** `H7451` [2] **role=standalone** — sense=evildoers; type=quality
- **root** `H8328` [2] **role=standalone** — sense=root; type=status
- **righteous** `H6662` [1/M26] **role=characteristic** — sense=righteous; type=quality
- **bears** `H5414` [1/M12] **role=characteristic** — sense=bears; type=action; operation=bears
...
- **eyes** `H5869` [2] **role=process-qualifier** — sense=eyes; type=status; operation=(qualifies) listens; manner=manner-of listens; coupling=welds listens
...
- **advice** `H6098` [1/M17] **role=process-qualifier** — sense=advice; type=status; operation=(qualifies) listens; manner=manner-of listens; coupling=welds listens
...
- **lips** `H8193` [2] **role=standalone** — sense=lips; type=status
- **endure** `H3559` [2] **role=standalone** — sense=endure; type=action; operation=endure
- **forever** `H5703` [2] **role=process-qualifier** — sense=forever; type=status; operation=(qualifies) endure; manner=manner-of endure; coupling=welds endure
...
- **ill** `H0205` [1/M10] **role=characteristic** — sense=ill; type=status; prohibition=forbidden (neg particle)
- **befalls** `H0579` [2] **role=standalone** — sense=befalls; type=action; operation=befalls; prohibition=forbidden (neg particle)
...
- **Anxiety** `H1674` [1/M01] **role=characteristic** — sense=Anxiety; type=status
- **man’s** `H0376` [2] **role=standalone** — sense=man’s; type=status
- **heart** `H3820` [1/M47] **role=process-qualifier** — sense=heart; type=status; operation=(qualifies) down; seat=heart; manner=manner-of down; coupling=welds down
- **good** `H2896` [1/M04] **role=characteristic** — sense=good; type=quality
...
- **slothful** `H7423` [2] **role=standalone** — sense=slothful; type=status; prohibition=forbidden (neg particle)
- **roast** `H2760` [2] **role=standalone** — sense=roast; type=action; operation=roast; prohibition=forbidden (neg particle)
- **game** `H6718` [2] **role=standalone** — sense=game; type=status; prohibition=forbidden (neg particle)
- **diligent** `H2742` [2] **role=standalone** — sense=diligent; type=quality; prohibition=forbidden (neg particle)
- **man** `H0120` [2] **role=standalone** — sense=man; type=status
