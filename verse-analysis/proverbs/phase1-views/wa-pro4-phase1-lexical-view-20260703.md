...
- **precepts** `H3948` [2] **role=standalone** — sense=precepts; type=status; prohibition=forbidden (neg particle)
- **forsake** `H5800` [2] **role=standalone** — sense=forsake; type=action; operation=forsake; prohibition=forbidden (neg particle)
- **teaching** `H8451` [2] **role=process-qualifier** — sense=teaching; type=status; operation=(qualifies) forsake; manner=manner-of forsake; coupling=welds forsake; prohibition=forbidden (neg particle)

## Pro 4:3

- **son** `H1121` [2] **role=standalone** — sense=son; type=status
- **father** `H0001` [2] **role=standalone** — sense=father; type=status
- **tender** `H7390` [2] **role=standalone** — sense=tender; type=quality
...
- **hold fast** `H8551` [2] **role=standalone** — sense=hold fast; type=action; operation=hold fast
...
- **highly** `H5549` [2] **role=standalone** — sense=highly; type=action; operation=highly
- **honor** `H3513` [2] **role=standalone** — sense=honor; type=action; operation=honor
- **embrace** `H2263` [2] **role=standalone** — sense=embrace; type=action; operation=embrace
...
- **step** `H6806` [2] **role=standalone** — sense=step; type=status; prohibition=forbidden (neg particle)
- **run** `H7323` [2] **role=standalone** — sense=run; type=action; operation=run; prohibition=forbidden (neg particle)
- **stumble** `H3782` [2] **role=standalone** — sense=stumble; type=action; operation=stumble; prohibition=forbidden (neg particle)

## Pro 4:13

- **hold** `H2388` [1/M23] **role=characteristic** — sense=hold; type=action; operation=hold; prohibition=forbidden (neg particle)
- **instruction** `H4148` [2] **role=process-qualifier** — sense=instruction; type=status; operation=(qualifies) hold; manner=manner-of hold; coupling=welds hold; prohibition=forbidden (neg particle)
- **go** `H7503` [1/M24] **role=characteristic** — sense=go; type=action; operation=go; prohibition=forbidden (neg particle)
- **guard** `H5341` [2] **role=standalone** — sense=guard; type=action; operation=guard; prohibition=forbidden (neg particle)
- **life** `H2416` [1/M25] **role=characteristic** — sense=life; type=status
...
- **Avoid** `H6544` [2] **role=standalone** — sense=Avoid; type=action; operation=Avoid; prohibition=forbidden (neg particle)
- **go on** `H5674` [2] **role=standalone** — sense=go on; type=action; operation=go on; prohibition=forbidden (neg particle)
- **turn away** `H7847` [2] **role=standalone** — sense=turn away; type=action; operation=turn away; prohibition=forbidden (neg particle)
- **pass on** `H5674` [2] **role=standalone** — sense=pass on; type=action; operation=pass on

## Pro 4:16

- **sleep** `H3462` [2] **role=standalone** — sense=sleep; type=action; operation=sleep; prohibition=forbidden (neg particle)
- **done wrong** `H7489` [1/M27] **role=characteristic** — sense=done wrong; type=action; operation=done wrong; prohibition=forbidden (neg particle)
- **robbed** `H1497` [2] **role=standalone** — sense=robbed; type=action; operation=robbed
...
- **escape** `H3868` [1/M14] **role=characteristic** — sense=escape; type=action; operation=escape; prohibition=forbidden (neg particle)
- **sight** `H5869` [2] **role=standalone** — sense=sight; type=status; prohibition=forbidden (neg particle)
- **keep** `H8104` [1/M30] **role=characteristic** — sense=keep; type=action; operation=keep
- **within** `H8432` [2] **role=process-qualifier** — sense=within; type=status; operation=(qualifies) keep; seat=heart; manner=manner-of keep; coupling=welds keep
...
- **gaze** `H6079` [2] **role=standalone** — sense=gaze; type=status
