# Base validation report — book 'Gen'

> Generated 2026-07-18T16:31:55Z. Read-only. Candidate (L4b) + passages.
...
| ✓ PASS | candidate spans stamped (book) | >=0 | 5939 |  |
...
| ✓ PASS | anchors = passage count | 787 | 787 |  |
| ✓ PASS | passages do not cross chapters | 0 | 0 |  |
| ⚠ WARN | passages needing review (> review_over verses) | reviewed | 21 flagged | a long run may be several passages — confirm the rule |
