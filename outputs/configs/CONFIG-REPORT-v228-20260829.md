...
| generated_at | 2026-08-29T13:27:12Z |
...
3. cfg_prose.prose.patch_output_dir = '"Sessions/Patches"' — 'sessions/patches' does not exist as a folder on disk (project-root-relative)
...
5. Catalogue-Report.ps1: no tab found in ps tools worksheet.xlsx (expected an embedded path cell 'iba\\app\\ps\\catalogue-report.ps1' in some tab's first rows)
...
6. Escalation.ps1 has parameter(s) ['ShortDescription', 'Source', 'Tried'] not used as a -Flag header anywhere in escalation actions worksheet.xlsx — the researcher's model sheet may need updating
