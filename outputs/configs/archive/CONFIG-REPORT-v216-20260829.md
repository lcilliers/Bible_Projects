...
| generated_at | 2026-08-29T05:45:17Z |
...
1. GOVERNANCE.md was last modified 2026-08-28T10:52:27Z, before the newest applied cfg_change_detail row (2026-08-29T05:45:02Z) — check whether that change needs an entry (GOVERNANCE.md §8's own rule)
...
4. Escalation.ps1 has parameter(s) ['AnsweredBy', 'RunId', 'ShortDescription', 'Source', 'Tried'] not used as a -Flag header anywhere in escalation actions worksheet.xlsx — the researcher's model sheet may need updating
...
**416** registered module(s) — **33** declared `config_exempt` (a legitimate zero for config-setting/enum usage, not a completeness gap), **362** inactive (module removed/merged). See §0 "Low config-density utilities" for any NON-exempt module still flagged.
