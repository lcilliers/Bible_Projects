...
| generated_at | 2026-08-28T09:20:09Z |
...
1. cfg_prose.prose.edit_file_dir = '"outputs/markdown/prose-edits"' — 'outputs/markdown/prose-edits' does not exist as a folder on disk (project-root-relative)
