...
| generated_at | 2026-09-05T12:10:11Z |
...
5. GOVERNANCE.md was last modified 2026-09-04T16:27:40Z, before the newest applied cfg_change_detail row (2026-09-05T12:10:11Z) — check whether that change needs an entry (GOVERNANCE.md §8's own rule)
...
8. window1-10verse-verse_lexical-20260905.csv: 3 versions simultaneously live ([1, 2, 3]) — only the highest should be; the rest belong in outputs/archive/
...
10. window1-layer1-layer2-review-20260905.md: 2 versions simultaneously live ([1, 2]) — only the highest should be; the rest belong in outputs/archive/
...
- **cfg_write_grant** (11): `candidate.curate -> candidate_seed`, `candidate.load -> candidate_seed`, `candidate.seed -> candidate_seed`, `candidate.seed -> lemma_inventory`, `candidate.set -> span_candidate`, `configmaint.propose -> cfg_change_detail`, `configmaint.propose -> cfg_change_log`, `configmaint.propose -> cfg_lexical_code_class`, `escalation -> word_registry`, `report.debate -> passage`, `run -> escalation`
