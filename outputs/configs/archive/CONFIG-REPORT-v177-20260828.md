...
| generated_at | 2026-08-28T10:16:54Z |
...
1. GOVERNANCE.md was last modified 2026-08-28T05:46:30Z, before the newest applied cfg_change_detail row (2026-08-28T10:16:53Z) — check whether that change needs an entry (GOVERNANCE.md §8's own rule)
...
**414** registered module(s) — **32** declared `config_exempt` (a legitimate zero for config-setting/enum usage, not a completeness gap), **361** inactive (module removed/merged). See §0 "Low config-density utilities" for any NON-exempt module still flagged.
