...
| generated_at | 2026-08-29T04:28:52Z |
...
1. GOVERNANCE.md was last modified 2026-08-28T10:52:27Z, before the newest applied cfg_change_detail row (2026-08-29T04:28:36Z) — check whether that change needs an entry (GOVERNANCE.md §8's own rule)
...
**PS/worksheet drift** (28) — a script's live param() names not matching its tab's flag headers in governance.ps_worksheet_path:
4. Behaviour.ps1: ps tools worksheet.xlsx tab 'Behaviour' is missing flag column(s) ['true'] — the script has these parameters now
5. Book-Narrative.ps1: ps tools worksheet.xlsx tab 'Book-Narrative' is missing flag column(s) ['true'] — the script has these parameters now
6. BookNarrative-Generate.ps1: ps tools worksheet.xlsx tab 'BookNarrative-Generate' is missing flag column(s) ['true'] — the script has these parameters now
7. BookNarrative-Validate.ps1: ps tools worksheet.xlsx tab 'BookNarrative-Validate' is missing flag column(s) ['true'] — the script has these parameters now
8. Build-Passages.ps1: ps tools worksheet.xlsx tab 'Build-Passages' is missing flag column(s) ['true'] — the script has these parameters now
9. Chapter-Generate.ps1: ps tools worksheet.xlsx tab 'Chapter-Generate' is missing flag column(s) ['true'] — the script has these parameters now
10. Cluster-Assign.ps1: ps tools worksheet.xlsx tab 'Cluster-Assign' is missing flag column(s) ['true'] — the script has these parameters now
11. Config-Maintenance.ps1: ps tools worksheet.xlsx tab 'Config-Maintenance' is missing flag column(s) ['true'] — the script has these parameters now
12. ContentIndex-Search.ps1: ps tools worksheet.xlsx tab 'ContentIndex-Search' is missing flag column(s) ['true'] — the script has these parameters now
13. Debate-Run.ps1: ps tools worksheet.xlsx tab 'Debate-Run' is missing flag column(s) ['true'] — the script has these parameters now
14. Export-Tables.ps1: ps tools worksheet.xlsx tab 'Export-Tables' is missing flag column(s) ['Database'] — the script has these parameters now
15. FolderPurpose.ps1: ps tools worksheet.xlsx tab 'FolderPurpose' is missing flag column(s) ['true'] — the script has these parameters now
16. Lexicon-Parse.ps1: ps tools worksheet.xlsx tab 'Lexicon-Parse' is missing flag column(s) ['true'] — the script has these parameters now
17. Manifest-Search.ps1: ps tools worksheet.xlsx tab 'Manifest-Search' is missing flag column(s) ['true'] — the script has these parameters now
18. New-Word.ps1: ps tools worksheet.xlsx tab 'New-Word' is missing flag column(s) ['true'] — the script has these parameters now
19. Operations-Ingest.ps1: ps tools worksheet.xlsx tab 'Operations-Ingest' is missing flag column(s) ['true'] — the script has these parameters now
20. PassageDebate-Report.ps1: ps tools worksheet.xlsx tab 'PassageDebate-Report' is missing flag column(s) ['true'] — the script has these parameters now
21. PassageDebate-Sync.ps1: ps tools worksheet.xlsx tab 'PassageDebate-Sync' is missing flag column(s) ['true'] — the script has these parameters now
22. PathAudit.ps1: ps tools worksheet.xlsx tab 'PathAudit' is missing flag column(s) ['true'] — the script has these parameters now
23. Prose.ps1: ps tools worksheet.xlsx tab 'Prose' is missing flag column(s) ['true'] — the script has these parameters now
24. Raw-Backfill.ps1: ps tools worksheet.xlsx tab 'Raw-Backfill' is missing flag column(s) ['true'] — the script has these parameters now
25. Reports.ps1: ps tools worksheet.xlsx tab 'Reports' is missing flag column(s) ['true'] — the script has these parameters now
26. Set-Candidates.ps1: ps tools worksheet.xlsx tab 'Set-Candidates' is missing flag column(s) ['true'] — the script has these parameters now
27. StrongVerse-Report.ps1: ps tools worksheet.xlsx tab 'StrongVerse-Report' is missing flag column(s) ['true'] — the script has these parameters now
28. VerseLexical.ps1: ps tools worksheet.xlsx tab 'VerseLexical' is missing flag column(s) ['true'] — the script has these parameters now
29. VerseSpanMeaning-Report.ps1: ps tools worksheet.xlsx tab 'VerseSpanMeaning-Report' is missing flag column(s) ['true'] — the script has these parameters now
30. WholeBookRead-Report.ps1: ps tools worksheet.xlsx tab 'WholeBookRead-Report' is missing flag column(s) ['true'] — the script has these parameters now
31. WordRegistrySpan-Report.ps1: ps tools worksheet.xlsx tab 'WordRegistrySpan-Report' is missing flag column(s) ['true'] — the script has these parameters now
...
32. Escalation.ps1 has parameter(s) ['Action', 'AnsweredBy', 'RunId', 'ShortDescription', 'Source', 'Tried', 'true'] not used as a -Flag header anywhere in escalation actions worksheet.xlsx — the researcher's model sheet may need updating
...
**415** registered module(s) — **33** declared `config_exempt` (a legitimate zero for config-setting/enum usage, not a completeness gap), **361** inactive (module removed/merged). See §0 "Low config-density utilities" for any NON-exempt module still flagged.
