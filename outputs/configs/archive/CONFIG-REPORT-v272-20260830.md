...
| generated_at | 2026-08-30T05:18:35Z |
...
3. GOVERNANCE.md was last modified 2026-08-30T04:44:27Z, before the newest applied cfg_change_detail row (2026-08-30T05:18:35Z) — check whether that change needs an entry (GOVERNANCE.md §8's own rule)
...
dedup key: `key_type, key_value, file_path`
| column | type | pk | notnull | unique | fk | use | source/filled_by |
| --- | --- | --- | --- | --- | --- | --- | --- |
