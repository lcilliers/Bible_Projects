...
| generated_at | 2026-08-28T09:36:55Z |
...
**413** registered module(s) — **32** declared `config_exempt` (a legitimate zero for config-setting/enum usage, not a completeness gap), **360** inactive (module removed/merged). See §0 "Low config-density utilities" for any NON-exempt module still flagged.
