...
| generated_at | 2026-09-20T08:41:54Z |
...
40. GOVERNANCE.md was last modified 2026-09-18T05:24:38Z, before the newest applied cfg_change_detail row (2026-09-20T08:41:54Z) — check whether that change needs an entry (GOVERNANCE.md §8's own rule)
...
| status | TEXT |  |  |  |  | Where the observation stands (5-value lifecycle, researcher-defined 2026-09-20, escalation #1782): needs-corroboration (observation detail is incomplete or needs revision) \| open (the default setting -- observation has not been confirmed) \| silent (captured but not included in any subsequent analysis) \| withdrawn (observation is incorrect or not useful) \| resolved (set only once the observation is cleared for inclusion in analysis). |  |
