...
| generated_at | 2026-09-20T12:32:30Z |
...
1. cfg_enum group 'cluster.status' (not looked up by name at runtime — no cfg.enum('cluster.status') or cfg_enum WHERE name='cluster.status' call site)
2. cfg_enum group 'cluster_subgroup.status' (not looked up by name at runtime — no cfg.enum('cluster_subgroup.status') or cfg_enum WHERE name='cluster_subgroup.status' call site)
3. cfg_enum group 'ib_observation.meaning_source' (not looked up by name at runtime — no cfg.enum('ib_observation.meaning_source') or cfg_enum WHERE name='ib_observation.meaning_source' call site)
4. cfg_enum group 'ib_observation.stage' (not looked up by name at runtime — no cfg.enum('ib_observation.stage') or cfg_enum WHERE name='ib_observation.stage' call site)
5. cfg_enum group 'ib_observation.status' (not looked up by name at runtime — no cfg.enum('ib_observation.status') or cfg_enum WHERE name='ib_observation.status' call site)
6. cfg_enum group 'ib_observation.window' (not looked up by name at runtime — no cfg.enum('ib_observation.window') or cfg_enum WHERE name='ib_observation.window' call site)
7. cfg_enum group 'party_kind' (not looked up by name at runtime — no cfg.enum('party_kind') or cfg_enum WHERE name='party_kind' call site)
8. cfg_enum group 'run_batch.status' (not looked up by name at runtime — no cfg.enum('run_batch.status') or cfg_enum WHERE name='run_batch.status' call site)
...
9. strong_meaning_parsed.lemma_key filled_by='lexicon.parse' (an inactive step) — confirm dormant or update to the real current writer
10. strong_meaning_parsed.sort filled_by='lexicon.parse' (an inactive step) — confirm dormant or update to the real current writer
11. strong_meaning_parsed.sense_code filled_by='lexicon.parse' (an inactive step) — confirm dormant or update to the real current writer
12. strong_meaning_parsed.gloss filled_by='lexicon.parse' (an inactive step) — confirm dormant or update to the real current writer
13. strong_meaning_parsed.verse_refs filled_by='lexicon.parse' (an inactive step) — confirm dormant or update to the real current writer
14. strong_meaning_parsed.note filled_by='lexicon.parse' (an inactive step) — confirm dormant or update to the real current writer
15. strong_meaning_parsed.row_type filled_by='lexicon.parse' (an inactive step) — confirm dormant or update to the real current writer
16. strong_lsj_parsed.strong filled_by='lexicon.parse' (an inactive step) — confirm dormant or update to the real current writer
17. strong_lsj_parsed.sense_label filled_by='lexicon.parse' (an inactive step) — confirm dormant or update to the real current writer
18. strong_lsj_parsed.gloss filled_by='lexicon.parse' (an inactive step) — confirm dormant or update to the real current writer
19. strong_lsj_parsed.note filled_by='lexicon.parse' (an inactive step) — confirm dormant or update to the real current writer
20. strong_lsj_parsed.row_type filled_by='lexicon.parse' (an inactive step) — confirm dormant or update to the real current writer
21. strong_mounce_parsed.strong filled_by='lexicon.parse' (an inactive step) — confirm dormant or update to the real current writer
22. strong_mounce_parsed.mounce_parsed filled_by='lexicon.parse' (an inactive step) — confirm dormant or update to the real current writer
23. strong_mounce_parsed.row_type filled_by='lexicon.parse' (an inactive step) — confirm dormant or update to the real current writer
24. passage.genre filled_by='lexical.enrich' (an inactive step) — confirm dormant or update to the real current writer
25. passage.lexical_complete_at filled_by='lexical.enrich' (an inactive step) — confirm dormant or update to the real current writer
26. verse_lexical_note.id filled_by='lexical.enrich' (an inactive step) — confirm dormant or update to the real current writer
27. verse_lexical_note.verse_lexical_id filled_by='lexical.enrich' (an inactive step) — confirm dormant or update to the real current writer
28. verse_lexical_note.verse_id filled_by='lexical.enrich' (an inactive step) — confirm dormant or update to the real current writer
29. verse_lexical_note.passage_id filled_by='lexical.enrich' (an inactive step) — confirm dormant or update to the real current writer
30. verse_lexical_note.note_type filled_by='lexical.enrich' (an inactive step) — confirm dormant or update to the real current writer
31. verse_lexical_note.resolution_status filled_by='lexical.enrich' (an inactive step) — confirm dormant or update to the real current writer
32. verse_lexical_note.target_verse_lexical_id filled_by='lexical.enrich' (an inactive step) — confirm dormant or update to the real current writer
33. verse_lexical_note.related_verse_lexical_ids filled_by='lexical.enrich' (an inactive step) — confirm dormant or update to the real current writer
34. verse_lexical_note.value_text filled_by='lexical.enrich' (an inactive step) — confirm dormant or update to the real current writer
35. verse_lexical_note.evidence_text filled_by='lexical.enrich' (an inactive step) — confirm dormant or update to the real current writer
36. verse_lexical_note.created_at filled_by='lexical.enrich' (an inactive step) — confirm dormant or update to the real current writer
...
38. GOVERNANCE.md was last modified 2026-09-18T05:24:38Z, before the newest applied cfg_change_detail row (2026-09-20T12:32:29Z) — check whether that change needs an entry (GOVERNANCE.md §8's own rule)
...
39. cfg_utility 'handlers_catalogue' (iba\app\handlers\catalogue.py) has zero Cfg-method call sites (.setting()/.enum()/.tables()/... under any variable name) — confirm this is a legitimate zero (mark `cfg_utility.config_exempt=1` via `configmaint.propose`) or a real completeness gap
40. cfg_utility 'lexicalenrich' (iba\app\lib\lexicalenrich.py) has zero Cfg-method call sites (.setting()/.enum()/.tables()/... under any variable name) — confirm this is a legitimate zero (mark `cfg_utility.config_exempt=1` via `configmaint.propose`) or a real completeness gap
41. cfg_utility 'lexicalscope' (iba\app\lib\lexicalscope.py) has zero Cfg-method call sites (.setting()/.enum()/.tables()/... under any variable name) — confirm this is a legitimate zero (mark `cfg_utility.config_exempt=1` via `configmaint.propose`) or a real completeness gap
42. cfg_utility 'apply_1598_phase_a_reallocation_v1_20260908' (iba\app\migration\apply_1598_phase_a_reallocation_v1_20260908.py) has zero Cfg-method call sites (.setting()/.enum()/.tables()/... under any variable name) — confirm this is a legitimate zero (mark `cfg_utility.config_exempt=1` via `configmaint.propose`) or a real completeness gap
43. cfg_utility 'apply_1598_cluster_batch' (iba\app\migration\apply_1598_cluster_batch.py) has zero Cfg-method call sites (.setting()/.enum()/.tables()/... under any variable name) — confirm this is a legitimate zero (mark `cfg_utility.config_exempt=1` via `configmaint.propose`) or a real completeness gap
44. cfg_utility 'clusterfamilyscan' (iba\app\lib\clusterfamilyscan.py) has zero Cfg-method call sites (.setting()/.enum()/.tables()/... under any variable name) — confirm this is a legitimate zero (mark `cfg_utility.config_exempt=1` via `configmaint.propose`) or a real completeness gap
45. cfg_utility 'create_verse_meta_table_v1_20260909' (iba\app\migration\create_verse_meta_table_v1_20260909.py) has zero Cfg-method call sites (.setting()/.enum()/.tables()/... under any variable name) — confirm this is a legitimate zero (mark `cfg_utility.config_exempt=1` via `configmaint.propose`) or a real completeness gap
46. cfg_utility 'drop_verse_meta_genre_column_v1_20260909' (iba\app\migration\drop_verse_meta_genre_column_v1_20260909.py) has zero Cfg-method call sites (.setting()/.enum()/.tables()/... under any variable name) — confirm this is a legitimate zero (mark `cfg_utility.config_exempt=1` via `configmaint.propose`) or a real completeness gap
47. cfg_utility 'add_verse_meta_status_column_v1_20260910' (iba\app\migration\add_verse_meta_status_column_v1_20260910.py) has zero Cfg-method call sites (.setting()/.enum()/.tables()/... under any variable name) — confirm this is a legitimate zero (mark `cfg_utility.config_exempt=1` via `configmaint.propose`) or a real completeness gap
48. cfg_utility 'VerseMeta.ps1' (iba\app\ps\VerseMeta.ps1) has zero Cfg-method call sites (.setting()/.enum()/.tables()/... under any variable name) — confirm this is a legitimate zero (mark `cfg_utility.config_exempt=1` via `configmaint.propose`) or a real completeness gap
49. cfg_utility 'apply_verse_plaintext_column' (iba\app\tools\_apply_verse_plaintext_column.py) has zero Cfg-method call sites (.setting()/.enum()/.tables()/... under any variable name) — confirm this is a legitimate zero (mark `cfg_utility.config_exempt=1` via `configmaint.propose`) or a real completeness gap
50. cfg_utility 'add_lexicon_header_pos_tags_setting_v1_20260910' (iba\app\migration\add_lexicon_header_pos_tags_setting_v1_20260910.py) has zero Cfg-method call sites (.setting()/.enum()/.tables()/... under any variable name) — confirm this is a legitimate zero (mark `cfg_utility.config_exempt=1` via `configmaint.propose`) or a real completeness gap
51. cfg_utility 'create_vw_strong_meaning_raw_v1_20260910' (iba\app\migration\create_vw_strong_meaning_raw_v1_20260910.py) has zero Cfg-method call sites (.setting()/.enum()/.tables()/... under any variable name) — confirm this is a legitimate zero (mark `cfg_utility.config_exempt=1` via `configmaint.propose`) or a real completeness gap
52. cfg_utility 'clusterstatus' (iba\app\lib\clusterstatus.py) has zero Cfg-method call sites (.setting()/.enum()/.tables()/... under any variable name) — confirm this is a legitimate zero (mark `cfg_utility.config_exempt=1` via `configmaint.propose`) or a real completeness gap
53. cfg_utility 'recordingpass' (iba\app\lib\recordingpass.py) has zero Cfg-method call sites (.setting()/.enum()/.tables()/... under any variable name) — confirm this is a legitimate zero (mark `cfg_utility.config_exempt=1` via `configmaint.propose`) or a real completeness gap
54. cfg_utility 'batchcontrol' (iba\app\lib\batchcontrol.py) has zero Cfg-method call sites (.setting()/.enum()/.tables()/... under any variable name) — confirm this is a legitimate zero (mark `cfg_utility.config_exempt=1` via `configmaint.propose`) or a real completeness gap
55. cfg_utility 'batchprogressreport' (iba\app\lib\batchprogressreport.py) has zero Cfg-method call sites (.setting()/.enum()/.tables()/... under any variable name) — confirm this is a legitimate zero (mark `cfg_utility.config_exempt=1` via `configmaint.propose`) or a real completeness gap
56. cfg_utility 'observationenhancer' (iba\app\handlers\observationenhancer.py) has zero Cfg-method call sites (.setting()/.enum()/.tables()/... under any variable name) — confirm this is a legitimate zero (mark `cfg_utility.config_exempt=1` via `configmaint.propose`) or a real completeness gap
...
**PS/worksheet drift** (0) — a script's live param() names not matching its tab's flag headers in governance.ps_worksheet_path:
_(none)_
...
92. [terminal] #2 step-not-done-without-validated-output — context_delivered
93. [terminal] #25 readonly-commands-no-permission-needed — context_delivered
94. [terminal] #27 heredoc-powershell-only — context_delivered
95. [terminal] #28 diagnose-reported-errors-dont-route-around — context_delivered
96. [terminal] #29 verify-fix-against-synthetic-and-real-case — context_delivered
...
97. [development] #65 audit-deliverable-cross-check-before-presenting — NOT DELIVERED: no verified delivery mechanism (memory file, governance.* setting, or CLAUDE.md/GOVERNANCE.md/USER-GUIDE.md-referenced doc)
98. [terminal] #27 heredoc-powershell-only — NOT DELIVERED: no verified delivery mechanism (memory file, governance.* setting, or CLAUDE.md/GOVERNANCE.md/USER-GUIDE.md-referenced doc)
...
99. iba/app/ps/Behaviour.ps1 calls iba.app.(handlers|lib|tools) directly, no iba.app.run dispatch found in the same file
100. iba/app/ps/VerseMeta.ps1 calls iba.app.(handlers|lib|tools) directly, no iba.app.run dispatch found in the same file
...
101. Workflow/Catalogue/1376-characteristic-tables-cross-db-inventory-v2-20260901.md — header names Escalation #1007, filename doesn't start with any of them
102. Workflow/Catalogue/1379-lexical-to-finding-worked-example-v1-20260901.md — header names Escalation #1378, filename doesn't start with any of them
103. Workflow/Catalogue/archive/1376-characteristic-tables-cross-db-inventory-v1-20260901.md — header names Escalation #1007, filename doesn't start with any of them
104. iba/docs/archive/escalation-decision-vs-defect-axis-proposal-v2-20260822.md — header names Escalation #798, filename doesn't start with any of them
105. iba/docs/archive/escalation-decision-vs-defect-axis-proposal-v3-20260822.md — header names Escalation #798, filename doesn't start with any of them
106. iba/docs/archive/escalation-decision-vs-defect-axis-proposal-v4-20260822.md — header names Escalation #798, filename doesn't start with any of them
107. iba/docs/archive/folder-purpose-governance-plan-v1-20260828.md — header names Escalation #971, filename doesn't start with any of them
108. iba/docs/archive/folder-purpose-governance-plan-v2-20260828.md — header names Escalation #971, filename doesn't start with any of them
109. iba/docs/archive/folder-purpose-governance-plan-v3-20260828.md — header names Escalation #971, filename doesn't start with any of them
110. iba/docs/archive/folder-purpose-governance-plan-v4-20260828.md — header names Escalation #971, filename doesn't start with any of them
111. iba/docs/archive/Passage read guidance-superseded-by-v1.2-20260727.md — filename contains a space (naming-shape: hyphens only)
112. iba/docs/archive/prose-store-iba-incorporation-plan-v2-20260822.md — header names Escalation #784, filename doesn't start with any of them
113. iba/docs/archive/prose-store-iba-incorporation-plan-v3-20260822.md — header names Escalation #784, filename doesn't start with any of them
114. iba/docs/escalation-795-outstanding-review-v1-20260822.md — header names Escalation #795, filename doesn't start with any of them
115. iba/docs/escalation-decision-vs-defect-axis-proposal-v5-20260822.md — header names Escalation #798, filename doesn't start with any of them
116. iba/docs/escalation-type-routing-proposal-v1-20260822.md — header names Escalation #795, filename doesn't start with any of them
117. iba/docs/file-naming-and-location-governance-plan-v1-20260826.md — header names Escalation #863, filename doesn't start with any of them
118. iba/docs/folder-purpose-governance-plan-v5-20260828.md — header names Escalation #971, filename doesn't start with any of them
119. iba/docs/prose-add-edit-rules-proposal-v1-20260826.md — header names Escalation #890, filename doesn't start with any of them
120. iba/docs/prose-book-aware-locations-plan-v1-20260828.md — header names Escalation #989, filename doesn't start with any of them
121. iba/docs/prose-book-extract-detail-design-20260823.md — header names Escalation #784, filename doesn't start with any of them
122. iba/docs/prose-book-extract-findings-20260823.md — header names Escalation #784, filename doesn't start with any of them
123. iba/docs/prose-file-control-v1-20260822.md — header names Escalation #784, filename doesn't start with any of them
124. iba/docs/prose-management-784-conversation-capture-v1-20260823.md — header names Escalation #784, filename doesn't start with any of them
125. iba/docs/prose-management-iba-v1-20260822.md — header names Escalation #784, filename doesn't start with any of them
126. iba/docs/prose-management-iba-v2-20260822.md — header names Escalation #784, filename doesn't start with any of them
127. iba/docs/prose-store-iba-incorporation-plan-v4-20260822.md — header names Escalation #784, filename doesn't start with any of them
...
128. cfg_method_rule #67 spine-on-demand-pull-mechanism — hedge phrase in rule_text/enforced_by with no resolution
129. cfg_method_rule #106 battery-scope-excludes-verse-reading-and-science-extract — hedge phrase in rule_text/enforced_by with no resolution
130. cfg_setting governance.prose_canonical_authority — hedge phrase in value/use
131. cfg_setting governance.procedural_document_taxonomy — hedge phrase in value/use
132. cfg_setting governance.engineering_documentation_folder — hedge phrase in value/use
...
133. scripts/SQLite/IBA_DB/explore clusters-2.sqlite3-query — contains a space, should use hyphens
134. scripts/SQLite/IBA_DB/explore verses.sqlite3-query — contains a space, should use hyphens
...
**462** registered module(s) — **33** declared `config_exempt` (a legitimate zero for config-setting/enum usage, not a completeness gap), **379** inactive (module removed/merged). See §0 "Low config-density utilities" for any NON-exempt module still flagged.
...
| lexical | lexical.meaning_max_verses_per_batch | 10 | Dedicated batch-size override for lexical.meaning only (#1723) -- front-loading (every M-code strong in a batch verse-count, not just the cluster's own members) multiplies expected output roughly by strong-density-per-batch. The shared passage.max_verses (20) truncated a real batch (55 strongs) even at lexical.llm_max_output_tokens=20000. Other passage.max_verses consumers (lexical.enrich) are unaffected by this override. |
...
| verse_reference | TEXT |  |  |  |  | resolved FRESH against iba.db.verse.reference at load time, never trusted from the LLM's JSON directly (#1693's own fix) |  |
...
| scope | TEXT |  | ✓ |  |  | Word/term (lexical) \| Verse-context \| Characteristic \| The HIB \| etc -- #1682 SS4A's own scope-category list |  |
...
| ib_observation.tag | instance-meaning, verse-grouping, difference-inference, surface-gloss-divergence, no-human-context, cross-cluster-significance, data-error, alternative-meaning, could-not-resolve, answered-no-flag, tightly-related, no-direct-connection, qualifier-for-term, no-impact, not-related-to-meaningful-word, sole-mcode-in-verse, cluster-pole-negative, cluster-pole-positive, attested-pre-nt, nt-coinage, needs_adjacent_verse_context |
| ib_observation.window | meaning, action-impact, relational, literary, cognitive, affective, operational, constitutional, origin, scientific, faculty |
