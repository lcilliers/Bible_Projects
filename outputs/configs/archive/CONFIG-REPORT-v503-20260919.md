...
| generated_at | 2026-09-19T03:38:01Z |
...
39. GOVERNANCE.md was last modified 2026-09-18T05:24:38Z, before the newest applied cfg_change_detail row (2026-09-19T03:38:01Z) — check whether that change needs an entry (GOVERNANCE.md §8's own rule)
...
**460** registered module(s) — **33** declared `config_exempt` (a legitimate zero for config-setting/enum usage, not a completeness gap), **379** inactive (module removed/merged). See §0 "Low config-density utilities" for any NON-exempt module still flagged.
...
| --- | --- | --- | --- |
|  | report.batch_progress_path | iba/app/reports/batch-progress.md |  |
