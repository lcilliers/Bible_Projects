...
| generated_at | 2026-09-10T03:31:05Z |
...
3. GOVERNANCE.md was last modified 2026-09-04T16:27:40Z, before the newest applied cfg_change_detail row (2026-09-10T03:31:04Z) — check whether that change needs an entry (GOVERNANCE.md §8's own rule)
...
- **cfg_write_grant** (12): `candidate.curate -> candidate_seed`, `candidate.load -> candidate_seed`, `candidate.seed -> candidate_seed`, `candidate.seed -> lemma_inventory`, `candidate.set -> span_candidate`, `configmaint.propose -> cfg_change_detail`, `configmaint.propose -> cfg_change_log`, `configmaint.propose -> cfg_lexical_code_class`, `escalation -> word_registry`, `lexical.enrich -> passage`, `report.debate -> passage`, `run -> escalation`
