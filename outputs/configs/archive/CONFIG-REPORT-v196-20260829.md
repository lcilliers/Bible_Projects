...
| generated_at | 2026-08-29T04:30:26Z |
...
4. Export-Tables.ps1: ps tools worksheet.xlsx tab 'Export-Tables' is missing flag column(s) ['Database'] — the script has these parameters now
...
5. Escalation.ps1 has parameter(s) ['AnsweredBy', 'RunId', 'ShortDescription', 'Source', 'Tried'] not used as a -Flag header anywhere in escalation actions worksheet.xlsx — the researcher's model sheet may need updating
