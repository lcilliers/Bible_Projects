...
| generated_at | 2026-09-03T04:58:17Z |
...
1. cfg_enum group 'behaviour_rule_enforcement_status' (not looked up by name at runtime — no cfg.enum('behaviour_rule_enforcement_status') or cfg_enum WHERE name='behaviour_rule_enforcement_status' call site)

**Settings needing justification** (2) — module already has its own dedicated table:
2. cfg_setting 'candidate.quality_report_path' (module 'candidate') — candidate already has its own dedicated table (cfg_candidate_rule); confirm this belongs in shared cfg_setting rather than there
3. cfg_setting 'candidate.load_report_path' (module 'candidate') — candidate already has its own dedicated table (cfg_candidate_rule); confirm this belongs in shared cfg_setting rather than there
...
4. GOVERNANCE.md was last modified 2026-08-31T10:03:34Z, before the newest applied cfg_change_detail row (2026-08-31T18:10:56Z) — check whether that change needs an entry (GOVERNANCE.md §8's own rule)
...
9. [chat] #17 confirm-before-nontrivial-work — not_mechanically_checkable
10. [chat] #18 output-to-file-not-chat-only — not_mechanically_checkable
11. [chat] #19 factual-discipline-no-guessing — not_mechanically_checkable
12. [chat] #20 cost-awareness-flag-cheaper-path — not_mechanically_checkable
13. [chat] #21 chat-items-become-escalations — not_mechanically_checkable
14. [chat] #22 proceed-autonomously-once-rules-are-stable — not_mechanically_checkable
15. [chat] #23 close-the-loop-not-just-report — not_mechanically_checkable
16. [chat] #24 show-evidence-dont-smooth-over — not_mechanically_checkable
17. [development] #38 root-fix-not-one-off — not_mechanically_checkable
18. [development] #39 simple-steps-not-engineered-designs — not_mechanically_checkable
19. [development] #40 open-items-route-through-escalation — not_mechanically_checkable
20. [development] #42 user-guide-updated-same-unit-of-work — judgment_call_pending
...
23. [documentation] #3 single-authority-pointer-not-copy — judgment_call_pending
24. [documentation] #15 obsidian-copy-not-authoritative — judgment_call_pending
25. [documentation] #31 guidance-baked-into-authoritative-record — not_mechanically_checkable
26. [documentation] #32 no-hedge-in-complete-records — partially_enforced
27. [documentation] #33 single-living-register-update-in-place — not_mechanically_checkable
28. [documentation] #34 source-of-truth-is-written-record — not_mechanically_checkable
29. [documentation] #35 consolidation-doc-must-be-load-bearing-or-retired — judgment_call_pending
30. [filing] #56 naming-shape — partially_enforced
31. [filing] #57 snapshot-vs-living-document — not_mechanically_checkable
32. [filing] #58 archiving-trigger — partially_enforced
33. [filing] #59 claude-code-filing-obligations — not_mechanically_checkable
34. [filing] #60 tool-report-path-vs-deliverable-document — judgment_call_pending
35. [llm_output] #4 inferential-not-confirmed — not_mechanically_checkable
36. [llm_output] #36 no-unsubstantiated-superlatives — not_mechanically_checkable
37. [llm_output] #37 derive-from-instruction-not-prior-unreviewed-output — not_mechanically_checkable
38. [sqlite] #1 verify-before-acting — not_mechanically_checkable
39. [sqlite] #11 readonly-by-default — not_mechanically_checkable
40. [sqlite] #12 never-write-via-adhoc-tool — judgment_call_pending
41. [sqlite] #13 dont-assume-which-database — not_mechanically_checkable
42. [sqlite] #14 query-file-conventions — judgment_call_pending
43. [sqlite] #30 writes-must-be-replayable — judgment_call_pending
44. [sqlite] #47 wa-session-research-flags-retained-as-is — not_mechanically_checkable
45. [sqlite] #54 prose-quality-flag-on-upstream-change — not_mechanically_checkable
46. [sqlite] #55 prose-section-type-creation-requires-researcher-instruction — not_mechanically_checkable
47. [sqlite] #61 inactive-tables-never-active-inputs — judgment_call_pending
48. [terminal] #2 step-not-done-without-validated-output — not_mechanically_checkable
49. [terminal] #25 readonly-commands-no-permission-needed — not_mechanically_checkable
50. [terminal] #27 heredoc-powershell-only — not_mechanically_checkable
51. [terminal] #28 diagnose-reported-errors-dont-route-around — not_mechanically_checkable
52. [terminal] #29 verify-fix-against-synthetic-and-real-case — not_mechanically_checkable
...
| enum | values |
| --- | --- |
| behaviour_rule_enforcement_status | mechanically_enforced, partially_enforced, buildable_not_built, judgment_call_pending, not_mechanically_checkable, deliberately_deferred |
