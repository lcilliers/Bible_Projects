...
| generated_at | 2026-08-28T03:46:35Z |
...
1. cfg_setting 'configmaint.csv_export_dir' (key not found together with a cfg.setting(...) call in any one file)
2. cfg_setting 'registry.folder_naming_convention' (key not found together with a cfg.setting(...) call in any one file)
3. cfg_setting 'report.book_folder_naming_convention' (key not found together with a cfg.setting(...) call in any one file)
...
4. GOVERNANCE.md was last modified 2026-08-28T03:39:59Z, before the newest applied cfg_change_detail row (2026-08-28T03:46:34Z) — check whether that change needs an entry (GOVERNANCE.md §8's own rule)
...
**411** registered module(s) — **31** declared `config_exempt` (a legitimate zero for config-setting/enum usage, not a completeness gap), **360** inactive (module removed/merged). See §0 "Low config-density utilities" for any NON-exempt module still flagged.
