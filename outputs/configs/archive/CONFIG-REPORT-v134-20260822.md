...
| generated_at | 2026-08-22T03:58:29Z |
...
1. GOVERNANCE.md was last modified 2026-08-21T16:05:00Z, before the newest applied cfg_change_detail row (2026-08-22T03:58:28Z) — check whether that change needs an entry (GOVERNANCE.md §8's own rule)

**Unregistered lib modules** (1) — iba/app/lib/*.py with no cfg_utility row:
2. iba/app/lib/prosestore.py has no cfg_utility row — run migration/bootstrap_cfg_utility.py to register it
...
| prose |  | 1.1 | prosestore.extract's JSON meta.extractor_version -- escalation #648 compliance fix, was a module-level constant in build_programme_prose_extract.py |
