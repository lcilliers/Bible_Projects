...
| generated_at | 2026-08-19T19:55:56Z |
...
### escalation
_one row per researcher interaction — the pause_ — One row per researcher interaction -- the pause. A pause, not a fork: the run resumes at resume_point when answered.
| column | type | pk | notnull | unique | fk | use | source/filled_by |
| --- | --- | --- | --- | --- | --- | --- | --- |
| id | INTEGER | ✓ |  |  |  | surrogate key |  |
...
| escalation_next_action | approve, reject, revise, noted, hold |
