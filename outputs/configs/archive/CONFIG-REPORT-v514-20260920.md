...
| generated_at | 2026-09-20T08:51:45Z |
...
**Orphan configs** (10) — a `cfg_setting`/`cfg_enum` not referenced by any code:
1. cfg_enum group 'cfg_observation_enhancer_rule.status' (not looked up by name at runtime — no cfg.enum('cfg_observation_enhancer_rule.status') or cfg_enum WHERE name='cfg_observation_enhancer_rule.status' call site)
2. cfg_enum group 'cluster.status' (not looked up by name at runtime — no cfg.enum('cluster.status') or cfg_enum WHERE name='cluster.status' call site)
3. cfg_enum group 'cluster_subgroup.status' (not looked up by name at runtime — no cfg.enum('cluster_subgroup.status') or cfg_enum WHERE name='cluster_subgroup.status' call site)
4. cfg_enum group 'ib_observation.meaning_source' (not looked up by name at runtime — no cfg.enum('ib_observation.meaning_source') or cfg_enum WHERE name='ib_observation.meaning_source' call site)
5. cfg_enum group 'ib_observation.stage' (not looked up by name at runtime — no cfg.enum('ib_observation.stage') or cfg_enum WHERE name='ib_observation.stage' call site)
6. cfg_enum group 'ib_observation.status' (not looked up by name at runtime — no cfg.enum('ib_observation.status') or cfg_enum WHERE name='ib_observation.status' call site)
7. cfg_enum group 'ib_observation.window' (not looked up by name at runtime — no cfg.enum('ib_observation.window') or cfg_enum WHERE name='ib_observation.window' call site)
8. cfg_enum group 'lexical_code_class' (not looked up by name at runtime — no cfg.enum('lexical_code_class') or cfg_enum WHERE name='lexical_code_class' call site)
9. cfg_enum group 'party_kind' (not looked up by name at runtime — no cfg.enum('party_kind') or cfg_enum WHERE name='party_kind' call site)
10. cfg_enum group 'run_batch.status' (not looked up by name at runtime — no cfg.enum('run_batch.status') or cfg_enum WHERE name='run_batch.status' call site)
...
11. strong_meaning_parsed.lemma_key filled_by='lexicon.parse' (an inactive step) — confirm dormant or update to the real current writer
12. strong_meaning_parsed.sort filled_by='lexicon.parse' (an inactive step) — confirm dormant or update to the real current writer
13. strong_meaning_parsed.sense_code filled_by='lexicon.parse' (an inactive step) — confirm dormant or update to the real current writer
14. strong_meaning_parsed.gloss filled_by='lexicon.parse' (an inactive step) — confirm dormant or update to the real current writer
15. strong_meaning_parsed.verse_refs filled_by='lexicon.parse' (an inactive step) — confirm dormant or update to the real current writer
16. strong_meaning_parsed.note filled_by='lexicon.parse' (an inactive step) — confirm dormant or update to the real current writer
17. strong_meaning_parsed.row_type filled_by='lexicon.parse' (an inactive step) — confirm dormant or update to the real current writer
18. strong_lsj_parsed.strong filled_by='lexicon.parse' (an inactive step) — confirm dormant or update to the real current writer
19. strong_lsj_parsed.sense_label filled_by='lexicon.parse' (an inactive step) — confirm dormant or update to the real current writer
20. strong_lsj_parsed.gloss filled_by='lexicon.parse' (an inactive step) — confirm dormant or update to the real current writer
21. strong_lsj_parsed.note filled_by='lexicon.parse' (an inactive step) — confirm dormant or update to the real current writer
22. strong_lsj_parsed.row_type filled_by='lexicon.parse' (an inactive step) — confirm dormant or update to the real current writer
23. strong_mounce_parsed.strong filled_by='lexicon.parse' (an inactive step) — confirm dormant or update to the real current writer
24. strong_mounce_parsed.mounce_parsed filled_by='lexicon.parse' (an inactive step) — confirm dormant or update to the real current writer
25. strong_mounce_parsed.row_type filled_by='lexicon.parse' (an inactive step) — confirm dormant or update to the real current writer
26. passage.genre filled_by='lexical.enrich' (an inactive step) — confirm dormant or update to the real current writer
27. passage.lexical_complete_at filled_by='lexical.enrich' (an inactive step) — confirm dormant or update to the real current writer
28. verse_lexical_note.id filled_by='lexical.enrich' (an inactive step) — confirm dormant or update to the real current writer
29. verse_lexical_note.verse_lexical_id filled_by='lexical.enrich' (an inactive step) — confirm dormant or update to the real current writer
30. verse_lexical_note.verse_id filled_by='lexical.enrich' (an inactive step) — confirm dormant or update to the real current writer
31. verse_lexical_note.passage_id filled_by='lexical.enrich' (an inactive step) — confirm dormant or update to the real current writer
32. verse_lexical_note.note_type filled_by='lexical.enrich' (an inactive step) — confirm dormant or update to the real current writer
33. verse_lexical_note.resolution_status filled_by='lexical.enrich' (an inactive step) — confirm dormant or update to the real current writer
34. verse_lexical_note.target_verse_lexical_id filled_by='lexical.enrich' (an inactive step) — confirm dormant or update to the real current writer
35. verse_lexical_note.related_verse_lexical_ids filled_by='lexical.enrich' (an inactive step) — confirm dormant or update to the real current writer
36. verse_lexical_note.value_text filled_by='lexical.enrich' (an inactive step) — confirm dormant or update to the real current writer
37. verse_lexical_note.evidence_text filled_by='lexical.enrich' (an inactive step) — confirm dormant or update to the real current writer
38. verse_lexical_note.created_at filled_by='lexical.enrich' (an inactive step) — confirm dormant or update to the real current writer
39. verse_lexical_note.deleted filled_by='lexical.enrich' (an inactive step) — confirm dormant or update to the real current writer

**Stale governance docs** (1) — GOVERNANCE.md older than the newest applied config change:
40. GOVERNANCE.md was last modified 2026-09-18T05:24:38Z, before the newest applied cfg_change_detail row (2026-09-20T08:46:36Z) — check whether that change needs an entry (GOVERNANCE.md §8's own rule)
...
41. cfg_utility 'handlers_catalogue' (iba\app\handlers\catalogue.py) has zero Cfg-method call sites (.setting()/.enum()/.tables()/... under any variable name) — confirm this is a legitimate zero (mark `cfg_utility.config_exempt=1` via `configmaint.propose`) or a real completeness gap
42. cfg_utility 'lexicalenrich' (iba\app\lib\lexicalenrich.py) has zero Cfg-method call sites (.setting()/.enum()/.tables()/... under any variable name) — confirm this is a legitimate zero (mark `cfg_utility.config_exempt=1` via `configmaint.propose`) or a real completeness gap
43. cfg_utility 'lexicalscope' (iba\app\lib\lexicalscope.py) has zero Cfg-method call sites (.setting()/.enum()/.tables()/... under any variable name) — confirm this is a legitimate zero (mark `cfg_utility.config_exempt=1` via `configmaint.propose`) or a real completeness gap
44. cfg_utility 'apply_1598_phase_a_reallocation_v1_20260908' (iba\app\migration\apply_1598_phase_a_reallocation_v1_20260908.py) has zero Cfg-method call sites (.setting()/.enum()/.tables()/... under any variable name) — confirm this is a legitimate zero (mark `cfg_utility.config_exempt=1` via `configmaint.propose`) or a real completeness gap
45. cfg_utility 'apply_1598_cluster_batch' (iba\app\migration\apply_1598_cluster_batch.py) has zero Cfg-method call sites (.setting()/.enum()/.tables()/... under any variable name) — confirm this is a legitimate zero (mark `cfg_utility.config_exempt=1` via `configmaint.propose`) or a real completeness gap
46. cfg_utility 'clusterfamilyscan' (iba\app\lib\clusterfamilyscan.py) has zero Cfg-method call sites (.setting()/.enum()/.tables()/... under any variable name) — confirm this is a legitimate zero (mark `cfg_utility.config_exempt=1` via `configmaint.propose`) or a real completeness gap
47. cfg_utility 'create_verse_meta_table_v1_20260909' (iba\app\migration\create_verse_meta_table_v1_20260909.py) has zero Cfg-method call sites (.setting()/.enum()/.tables()/... under any variable name) — confirm this is a legitimate zero (mark `cfg_utility.config_exempt=1` via `configmaint.propose`) or a real completeness gap
48. cfg_utility 'drop_verse_meta_genre_column_v1_20260909' (iba\app\migration\drop_verse_meta_genre_column_v1_20260909.py) has zero Cfg-method call sites (.setting()/.enum()/.tables()/... under any variable name) — confirm this is a legitimate zero (mark `cfg_utility.config_exempt=1` via `configmaint.propose`) or a real completeness gap
49. cfg_utility 'add_verse_meta_status_column_v1_20260910' (iba\app\migration\add_verse_meta_status_column_v1_20260910.py) has zero Cfg-method call sites (.setting()/.enum()/.tables()/... under any variable name) — confirm this is a legitimate zero (mark `cfg_utility.config_exempt=1` via `configmaint.propose`) or a real completeness gap
50. cfg_utility 'VerseMeta.ps1' (iba\app\ps\VerseMeta.ps1) has zero Cfg-method call sites (.setting()/.enum()/.tables()/... under any variable name) — confirm this is a legitimate zero (mark `cfg_utility.config_exempt=1` via `configmaint.propose`) or a real completeness gap
51. cfg_utility 'apply_verse_plaintext_column' (iba\app\tools\_apply_verse_plaintext_column.py) has zero Cfg-method call sites (.setting()/.enum()/.tables()/... under any variable name) — confirm this is a legitimate zero (mark `cfg_utility.config_exempt=1` via `configmaint.propose`) or a real completeness gap
52. cfg_utility 'add_lexicon_header_pos_tags_setting_v1_20260910' (iba\app\migration\add_lexicon_header_pos_tags_setting_v1_20260910.py) has zero Cfg-method call sites (.setting()/.enum()/.tables()/... under any variable name) — confirm this is a legitimate zero (mark `cfg_utility.config_exempt=1` via `configmaint.propose`) or a real completeness gap
53. cfg_utility 'create_vw_strong_meaning_raw_v1_20260910' (iba\app\migration\create_vw_strong_meaning_raw_v1_20260910.py) has zero Cfg-method call sites (.setting()/.enum()/.tables()/... under any variable name) — confirm this is a legitimate zero (mark `cfg_utility.config_exempt=1` via `configmaint.propose`) or a real completeness gap
54. cfg_utility 'clusterstatus' (iba\app\lib\clusterstatus.py) has zero Cfg-method call sites (.setting()/.enum()/.tables()/... under any variable name) — confirm this is a legitimate zero (mark `cfg_utility.config_exempt=1` via `configmaint.propose`) or a real completeness gap
55. cfg_utility 'recordingpass' (iba\app\lib\recordingpass.py) has zero Cfg-method call sites (.setting()/.enum()/.tables()/... under any variable name) — confirm this is a legitimate zero (mark `cfg_utility.config_exempt=1` via `configmaint.propose`) or a real completeness gap
56. cfg_utility 'batchcontrol' (iba\app\lib\batchcontrol.py) has zero Cfg-method call sites (.setting()/.enum()/.tables()/... under any variable name) — confirm this is a legitimate zero (mark `cfg_utility.config_exempt=1` via `configmaint.propose`) or a real completeness gap
57. cfg_utility 'batchprogressreport' (iba\app\lib\batchprogressreport.py) has zero Cfg-method call sites (.setting()/.enum()/.tables()/... under any variable name) — confirm this is a legitimate zero (mark `cfg_utility.config_exempt=1` via `configmaint.propose`) or a real completeness gap
58. cfg_utility 'observationenhancer' (iba\app\handlers\observationenhancer.py) has zero Cfg-method call sites (.setting()/.enum()/.tables()/... under any variable name) — confirm this is a legitimate zero (mark `cfg_utility.config_exempt=1` via `configmaint.propose`) or a real completeness gap
...
59. iba/app/lib/prosestore.py builds a -v{n} filename by hand — no filingkit.versioned_path()/reportkit.oneoff_path() call site in the same file
...
- **cfg_enum** (43): `candidate_decision=candidate`, `candidate_decision=exception`, `candidate_decision=rejected`, `candidate_decision=undecided`, `candidate_ib_referent=body_part`, `candidate_ib_referent=characteristic`, `candidate_ib_referent=other_being`, `candidate_source=curated-synonym`, `candidate_source=ib-judgement`, `candidate_source=read-emergent`, `candidate_source=registry-direct`, `candidate_step_status=in_strong`, `candidate_step_status=not_in_step`, `candidate_step_status=step_has_verses_pending`, `candidate_step_status=step_no_verses`, `escalation_answer=approve`, `escalation_answer=reject`, `escalation_answer=revise`, `escalation_next_action=approve`, `escalation_next_action=approved`, `escalation_next_action=hold`, `escalation_next_action=noted`, `escalation_next_action=ready_for_approval`, `escalation_next_action=reject`, `escalation_next_action=review`, `escalation_next_action=revise`, `escalation_requirement_check_kind=requires_prior_ready_for_approval_if_decision_required`, `escalation_state=answered`, `escalation_state=paused`, `escalation_state=re-assign`, `escalation_state=retracted`, `escalation_type=crash`, `escalation_type=interactive`, `escalation_type=prompted`, `escalation_type=report-stop`, `ib_observation.tag=cross-cluster-significance`, `ib_observation.tag=instance-meaning`, `passage_source=passage-build`, `passage_source=single-verse-emergent`, `prose_section_type_lifecycle_tag=source`, `prose_section_type_lifecycle_tag=v1`, `prose_section_type_lifecycle_tag=v2`, `prose_section_type_lifecycle_tag=v3`
