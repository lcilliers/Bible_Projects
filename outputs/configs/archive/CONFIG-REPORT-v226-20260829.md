...
| generated_at | 2026-08-29T13:20:05Z |
...
1. cfg_setting 'report.whole_book_read_naming_pattern' (key not found together with a cfg.setting(...) call in any one file)
2. cfg_setting 'report.verse_lexical_output_pattern' (key not found together with a cfg.setting(...) call in any one file)
3. cfg_setting 'report.word_registry_span_output_dir' (key not found together with a cfg.setting(...) call in any one file)
4. cfg_setting 'report.strong_verse_output_dir' (key not found together with a cfg.setting(...) call in any one file)
5. cfg_setting 'cluster.quality_report_path' (key not found together with a cfg.setting(...) call in any one file)
6. cfg_setting 'escalation.control_objectives' (key not found together with a cfg.setting(...) call in any one file)
7. cfg_setting 'escalation.control_process' (key not found together with a cfg.setting(...) call in any one file)
8. cfg_setting 'behaviour.list_report_path' (key not found together with a cfg.setting(...) call in any one file)
9. cfg_setting 'pathaudit.report_path' (key not found together with a cfg.setting(...) call in any one file)

**Settings needing justification** (2) — module already has its own dedicated table:
10. cfg_setting 'candidate.quality_report_path' (module 'candidate') — candidate already has its own dedicated table (cfg_candidate_rule); confirm this belongs in shared cfg_setting rather than there
11. cfg_setting 'candidate.load_report_path' (module 'candidate') — candidate already has its own dedicated table (cfg_candidate_rule); confirm this belongs in shared cfg_setting rather than there
...
12. cfg_prose.prose.patch_output_dir = '"Sessions/Patches"' — 'sessions/patches' does not exist as a folder on disk (project-root-relative)
...
14. Catalogue-Report.ps1: no tab found in ps tools worksheet.xlsx (expected an embedded path cell 'iba\\app\\ps\\catalogue-report.ps1' in some tab's first rows)
...
15. Escalation.ps1 has parameter(s) ['ShortDescription', 'Source', 'Tried'] not used as a -Flag header anywhere in escalation actions worksheet.xlsx — the researcher's model sheet may need updating
