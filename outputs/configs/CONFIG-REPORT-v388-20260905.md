...
| generated_at | 2026-09-05T12:43:48Z |
...
2. cfg_enum group 'note_type' (not looked up by name at runtime — no cfg.enum('note_type') or cfg_enum WHERE name='note_type' call site)
3. cfg_enum group 'party_kind' (not looked up by name at runtime — no cfg.enum('party_kind') or cfg_enum WHERE name='party_kind' call site)
4. cfg_enum group 'resolution_status' (not looked up by name at runtime — no cfg.enum('resolution_status') or cfg_enum WHERE name='resolution_status' call site)
...
5. GOVERNANCE.md was last modified 2026-09-04T16:27:40Z, before the newest applied cfg_change_detail row (2026-09-05T12:43:47Z) — check whether that change needs an entry (GOVERNANCE.md §8's own rule)
...
**Report version clutter** (4) — more than one version of a one-off report simultaneously live in governance.oneoff_report_dir (oneoff_path() found 2026-08-08 to version without archiving, BUILD.md §83) — the rest belong in archive/:
8. window1-10verse-verse_lexical-20260905.csv: 4 versions simultaneously live ([1, 2, 3, 4]) — only the highest should be; the rest belong in outputs/archive/
9. window1-10verse-verse_lexical_note-20260905.csv: 3 versions simultaneously live ([1, 2, 3]) — only the highest should be; the rest belong in outputs/archive/
10. window1-layer1-layer2-review-20260905.md: 3 versions simultaneously live ([1, 2, 3]) — only the highest should be; the rest belong in outputs/archive/
11. window1-layer2-10verse-test-20260905.md: 2 versions simultaneously live ([1, 2]) — only the highest should be; the rest belong in outputs/archive/
...
**431** registered module(s) — **33** declared `config_exempt` (a legitimate zero for config-setting/enum usage, not a completeness gap), **373** inactive (module removed/merged). See §0 "Low config-density utilities" for any NON-exempt module still flagged.
