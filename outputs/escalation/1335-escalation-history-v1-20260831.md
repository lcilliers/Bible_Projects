...
## #1335 — Register schema_overview_bible_research tables section
type=issue source=configmaint

**v1** (2026-08-31T08:56:32Z, Claude) state=raised next_action=review assigned_to=Researcher
> **short description (set this version):** Register schema_overview_bible_research tables section
...
> **context (set this version):** {"table": "cfg_report_section", "op": "insert", "where": {}, "set": {"step": "report.schema_overview_bible_research", "ordinal": 1, "section_key": "tables", "heading": "## Every table, in full", "toc_label": "Every table, in full", "include": 1, "inactive": 0}, "full_message": "Step 5 of 6 for escalation #1306's fix."}
