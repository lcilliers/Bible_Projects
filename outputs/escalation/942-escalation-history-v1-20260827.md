...
## #942 — Folder-destination realignment (escalation #929/#736): repo…
type=issue source=configmaint

**v1** (2026-08-27T19:08:31Z, Claude) state=raised next_action=review assigned_to=Researcher
...
> **context (set this version):** {"table": "cfg_setting", "op": "update", "where": {"key": "content_index.size_profile_report_path"}, "set": {"value": "\"outputs/content_index/content-index-size-profile.md\""}, "full_message": "Folder-destination realignment (escalation #929/#736): repoint content_index.size_profile_report_path to outputs/content_index/content-index-size-profile.md."}
...
**v3** (2026-08-27T19:13:07Z, Researcher) state=in-progress next_action=review assigned_to=Claude
