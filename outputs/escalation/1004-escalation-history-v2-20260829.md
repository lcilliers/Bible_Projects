...
**v3** (2026-08-29T04:25:02Z, Researcher) state=completed next_action=approved assigned_to=Researcher
> **comment (set this version):** looking good, it is now a intergral part of the app and the main place where I can prepare the instructions  
