...
| front-loaded-exposure | 13 |
| subject-missing | 11 |
| stage4-not-exposed | 5 |
| grain-vague | 4 |
| jargon | 4 |
| compound | 3 |
| subject-partial | 1 |
...
Full CSV (all 103 rows, current + revised text, no truncation): `catalogue-question-wording-review-20260921-v3.csv` (same folder).
