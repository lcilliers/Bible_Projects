...
Full CSV (all 103 rows, current + revised text, no truncation): `catalogue-question-wording-review-20260921.csv` (same folder).
...
- **revised:** Across the evidence, does the characteristic show any orientation toward a future fullness the person moves toward, not only what they currently are? Record it, or record none.
- **rationale:** Original never names 'the characteristic' -- 'is there any orientation' floats without a subject unless read together with D10.1.1.
...
- **revised:** Across the verses, is the characteristic's immediate inner-being response (per D10.2.1) consistent or varied by context?
- **rationale:** 'that immediate response' is a bare pronoun with no restated subject -- unreadable standalone.
...
- **revised:** Across the verses, how does the characteristic's sustained effect (D10.3.1) differ from its immediate response (D10.2.1)?
- **rationale:** 'the sustained effect' unrestated; no aggregate/verse marker at all.
...
- **revised:** Across the evidence, is the characteristic's transformation (per D10.4.1) reversible or irreversible?
- **rationale:** 'the transformation' unrestated; 'in the evidence' as a trailing clause is weaker than a leading grain marker.
...
- **revised:** Across the evidence, does the characteristic's mechanism of change (per D10.6.1) differ by context, and if so how?
- **rationale:** 'the mechanism' unrestated.
...
- **rationale:** Subject + grain (across the evidence) explicit.
...
- **revised:** Across the verses, is the characteristic's felt quality (per D2.1.1) consistent, or does it vary by context?
- **rationale:** 'the felt quality' unrestated.
...
- **revised:** Across the verses, does the characteristic's mode of operation (per D3.1.1) vary by context, direction, or constitutional level; if so how?
- **rationale:** 'the mode of operation' unrestated; no grain marker at all.
...
- **revised:** Across the verses, does the characteristic ever operate through a communicative or speech-based mode (commanded, addressed, spoken); if so how? Record it, or record none.
...
- **revised:** Across the evidence, under what inner conditions does the characteristic take hold or operate rightly?
- **rationale:** No grain marker at all.
...
- **revised:** Across the evidence, under what inner conditions is the characteristic blocked, distorted, resisted, or not taken up -- including, where shown, distortion or interference by another spirit (adversarial or angelic)?
- **rationale:** 'where the evidence shows it' is a buried, secondary clause, not a leading grain statement.
...
- **revised:** Across the evidence, what is the inner-being state of the person in whom the characteristic is present but does not take hold (per D3.2.2)?
- **rationale:** No grain marker; implicitly continues D3.2.2's 'not taken up' case without citing it.
...
- **rationale:** Subject explicit; grain present via 'the evidence show'.
...
- **rationale:** Subject explicit; grain present via 'as the evidence shows'.
...
- **revised:** Across the evidence, what does the pattern of presence/absence found in D5.1.1 indicate for the characteristic's place in the human person and in the divine image?
- **rationale:** Properly cites D5.1.1 by code (good practice) but has no grain marker. NOTE: scope tag 'Other non-human beings' does not match this question's actual content (human person / divine image) -- flag to #1806.
...
- **revised:** Across the evidence, what inner posture does the characteristic's God-ward movement (per D5.2.1) require?
- **rationale:** 'this movement' unrestated.

### D5.2.3 — REVISE

- **scope:** Other non-human beings | **window:** relational
- **current:** What does the human-to-God direction of the characteristic show about the person's relationship with God?
- **revised:** Across the evidence, what does the characteristic's human-to-God direction show about the person's relationship with God?
- **rationale:** Subject is self-descriptive and fine; no grain marker.
...
- **revised:** Across the evidence, from the characteristic's God-relation (D5.1/D7.6) and its role (D10.1/D11.1), what aspect of the divine likeness, if any, does it instantiate in the person? Record the aspect, or record none.
- **rationale:** Model citation practice (cites D5.1/D7.6/D10.1/D11.1 by code) -- exactly what other REVISE items below should imitate. Only missing a grain marker.
...
- **revised:** Across the evidence, where the characteristic is present or absent, what does that indicate about the condition of the divine image in the person -- or is no indication evidenced?
- **rationale:** 'Where...is present or absent' could be read as per-verse or aggregate; no explicit marker either way.
...
- **revised:** Across the evidence, where a body link exists (per D6.1.1), in which direction does it run -- soul/spirit expressing through the body, the body feeding back to the soul, or both -- and what follows from that direction? If no body link, record none.
- **rationale:** Good citation of D6.1.1 by name; only missing a grain marker.
...
- **revised:** Across the evidence, does the characteristic move across constitutional levels (spirit->soul->body), or onto the person from an external source -- including another spirit (angelic or adversarial) -- or in another direction; and if so in what sequence or pattern? If no movement, record none.
- **rationale:** Subject explicit; no grain marker.
...
- **revised:** Across the evidence, what does God's extension of the characteristic (per D7.1.1) show about his disposition toward the human person?
- **rationale:** Subject self-descriptive but adding the D7.1.1 citation removes any doubt; no grain marker in original.
...
- **revised:** Across the evidence, what inner conditions or orientations in the giver accompany genuine extension of the characteristic (per D7.2.1)?
- **rationale:** Subject self-descriptive; no grain marker.
...
- **revised:** Across the evidence, what inner conditions accompany or block uptake of the characteristic from another person (per D7.3.1)?
- **rationale:** No grain marker.

### D7.3.3 — REVISE

- **scope:** Characteristic relational | **window:** relational
- **current:** What is the inner-being state of the person who meets the characteristic from another but does not take it up?
- **revised:** Across the evidence, what is the inner-being state of the person who meets the characteristic from another but does not take it up (per D7.3.2)?
- **rationale:** No grain marker; implicitly continues D7.3.2's 'block' case without citing it.
...
- **revised:** Across the evidence, what does the pattern of adversarial-being presence (per D7.4.2a) show about the characteristic being a site of adversarial activity?
- **rationale:** 'that pattern' unrestated; no grain marker.
...
- **revised:** Across the evidence, what does the pattern of angelic-being presence (per D7.4.3a) show about the characteristic being communicated, strengthened, or mediated through angelic ministry?
- **rationale:** 'that pattern' unrestated; no grain marker.
...
- **revised:** Across the verses, is the characteristic's origin (per D7.5.1) single or multiple, and does it change with context?
- **rationale:** 'the origin' unrestated (though reasonably guessable, still not self-contained per the standard applied elsewhere).
...
- **rationale:** Subject + grain (in the verse evidence, aggregate) explicit.

### X0.1.2 — REVISE

- **scope:** Characteristic relational | **window:** relational
- **current:** What does the co-occurrence pattern show about this characteristic's place in the inner-being landscape?
- **revised:** Across the evidence, what does the characteristic's co-occurrence pattern (per X0.1.1) show about its place in the inner-being landscape?
- **rationale:** Subject reasonably self-descriptive ('the co-occurrence pattern' names its own topic, unlike a bare pronoun) but no grain marker.
...
- **rationale:** Subject + grain (the evidence show) explicit.

### X0.2.2 — REVISE

- **scope:** Characteristic relational | **window:** relational
- **current:** What does the sequence show — is the relationship causal, developmental, or correlational?
- **revised:** Across the evidence, what does the characteristic's sequence pattern (per X0.2.1) show -- is the relationship causal, developmental, or correlational?
- **rationale:** Subject self-descriptive; no grain marker.
...
- **rationale:** Subject + grain (in the evidence) explicit.

### X0.3.2 — REVISE

- **scope:** Characteristic relational | **window:** relational
- **current:** Is this characteristic produced by another, and if so which?
- **revised:** Across the evidence, is this characteristic produced by another, and if so which?
- **rationale:** No grain marker.
...
- **revised:** Across the evidence, is this characteristic a constituent element of another, or another a constituent of this one?
- **rationale:** No grain marker.
...
- **revised:** Where the evidence shows apparent overlap between this characteristic and its nearest neighbour (per X0.5.1), what is the precise boundary between them?
- **rationale:** 'apparent overlap' floats without naming what it's overlap WITH until X0.5.1 is read.

### X0.5.3 — REVISE

- **scope:** Characteristic relational | **window:** relational
- **current:** Is the distinction from the nearest neighbour one of degree, kind, direction, or constitutional level?
- **revised:** Across the evidence, is the distinction between this characteristic and its nearest neighbour one of degree, kind, direction, or constitutional level?
- **rationale:** 'the nearest neighbour' reuses X0.5.1's defined term correctly (good practice), but no grain marker.
