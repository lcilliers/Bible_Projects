...
| PINNED-STAGE1 | 3 | Stage 1, exact hardcoded code (D7.7.1, M0.6.5, M0.6.6) -- works today, not auto-updating |
...
All 104 rows. Full question text is in the CSV (`catalogue-coverage-audit-20260921-v5.csv`, same folder) — truncated to 90 chars here for table width.
...
| M0.6.6 | The verse | active | 0 | PINNED-STAGE1 | verse-reading | 0 | Taking every M-code characteristic present in this verse together, what is the overall rel... |
