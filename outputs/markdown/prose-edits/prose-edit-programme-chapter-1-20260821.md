# Prose Edit — Programme — Chapter 1
...
<!-- PROSE_SECTION_ID: 2 -->
<!-- PROSE_SECTION_TYPE: prog_purp_mission -->
<!-- PROSE_BOOK: Programme -->
<!-- PROSE_SECTION: Programme -->
<!-- PROSE_CHAPTER_NO: 1 -->
<!-- PROSE_CHAPTER_TITLE: Mission -->
<!-- PROSE_SORT_ORDER: 2 -->
<!-- PROSE_VERSION: 1 -->
<!-- PROSE_SOURCE_FILE: wa-prose-draft-purp-mission-v2-20260421.md -->
...
<!-- PROSE_SECTION_ID: 3 -->
<!-- PROSE_SECTION_TYPE: prog_purp_scope -->
<!-- PROSE_BOOK: Programme -->
<!-- PROSE_SECTION: Programme -->
<!-- PROSE_CHAPTER_NO: 1 -->
<!-- PROSE_CHAPTER_TITLE: Scope -->
<!-- PROSE_SORT_ORDER: 3 -->
<!-- PROSE_VERSION: 1 -->
<!-- PROSE_SOURCE_FILE: wa-prose-draft-purp-scope-v1-20260421.md -->
...
<!-- PROSE_SECTION_ID: 4 -->
<!-- PROSE_SECTION_TYPE: prog_purp_this_inner_being_programme -->
<!-- PROSE_BOOK: Programme -->
<!-- PROSE_SECTION: Programme -->
<!-- PROSE_CHAPTER_NO: 1 -->
<!-- PROSE_CHAPTER_TITLE: This Inner-Being Programme -->
<!-- PROSE_SORT_ORDER: 4 -->
<!-- PROSE_VERSION: 1 -->
<!-- PROSE_SOURCE_FILE: wa-prose-draft-purp-thisprog-v1-20260421.md -->
...
<!-- PROSE_SECTION_ID: 5 -->
<!-- PROSE_SECTION_TYPE: prog_purp_defining_inner_being -->
<!-- PROSE_BOOK: Programme -->
<!-- PROSE_SECTION: Programme -->
<!-- PROSE_CHAPTER_NO: 1 -->
<!-- PROSE_CHAPTER_TITLE: Defining Inner Being -->
<!-- PROSE_SORT_ORDER: 6 -->
<!-- PROSE_VERSION: 1 -->
<!-- PROSE_SOURCE_FILE: wa-prose-draft-purp-definition-v1-20260421.md -->
...
<!-- PROSE_SECTION_ID: 6 -->
<!-- PROSE_SECTION_TYPE: prog_purp_science_and_bible -->
<!-- PROSE_BOOK: Programme -->
<!-- PROSE_SECTION: Programme -->
<!-- PROSE_CHAPTER_NO: 1 -->
<!-- PROSE_CHAPTER_TITLE: Science and the Bible -->
<!-- PROSE_SORT_ORDER: 7 -->
<!-- PROSE_VERSION: 1 -->
<!-- PROSE_SOURCE_FILE: wa-prose-draft-purp-scienceandbible-v1-20260421.md -->
...
<!-- PROSE_SECTION_ID: 7 -->
<!-- PROSE_SECTION_TYPE: prog_purp_expected_outcome -->
<!-- PROSE_BOOK: Programme -->
<!-- PROSE_SECTION: Programme -->
<!-- PROSE_CHAPTER_NO: 1 -->
<!-- PROSE_CHAPTER_TITLE: Expected Outcome -->
<!-- PROSE_SORT_ORDER: 8 -->
<!-- PROSE_VERSION: 1 -->
<!-- PROSE_SOURCE_FILE: wa-prose-draft-purp-outcome-v1-20260421.md -->
