...
> Generated 2026-08-17T03:37:02Z by `cluster.validate`. Read-only findings, not a gate.

- `strong` rows with no cluster assignment at all: **7979**
- `backfill`-origin, non-T2 assignment, not yet promoted (should be `word`): **0**
- exception — non-T2 assignment with no `word_registry` link: **746**
- exception — `backfill` code with an active/clustered sibling: **825**
...
exception — no word: 746
exception — sibling conflict: 825
...
`G0402` — 'to leave', cluster M11
`G0436` — 'to oppose', cluster M06
`G0476` — 'opponent', cluster M06
`G0527` — 'tender', cluster M05
`G0611` — 'to answer', cluster M24
`G0622` — 'to destroy', cluster M10
`G0672` — 'to leave', cluster M11
`G0684` — 'destruction', cluster M10
`G0694` — 'money', cluster M28
...
`G2948` — 'crippled', cluster M24
`G2962H` — 'lord: master', cluster M23
`G3039` — 'to crush', cluster M24
`G3332` — 'to leave', cluster M11
`G3423` — 'to betroth', cluster M44
`G3429` — 'to commit adultery', cluster M10
...
`G0216` — 'mute', cluster M07
`G0657` — 'to leave', cluster M11
...
`G4229` — 'thing', cluster M28
`G4273` — 'traitor', cluster M14
`G4422` — 'to frighten', cluster M01
`G4485` — 'destruction', cluster M10
`G4617` — 'to sift', cluster M35
`G4648` — 'to watch out', cluster M06
...
`G5050` — 'perfection', cluster M12
`G5135` — 'to wound', cluster M03
...
`G2880` — 'to satisfy', cluster M46
`G3116` — 'patiently', cluster M34
`G3143` — 'to testify', cluster M13
...
`G1373` — 'thirst', cluster M29
`G1389` — 'to distort', cluster M14
`G2236` — 'most gladly', cluster M04
`G2506` — 'destruction', cluster M10
`G2583` — 'rule', cluster M23
`G2676` — 'perfection', cluster M12
...
`G4509` — 'filth', cluster M07
`G4599` — 'to strengthen', cluster M23
`G5391` — 'friendly', cluster M05
`G5612` — 'to roar', cluster M42
`G1955` — 'explanation', cluster M15
`G3024` — 'forgetfulness', cluster M41
...
`G3455` — 'to roar', cluster M42
`H0565A` — 'word', cluster M15
...
`H6616` — 'cord', cluster M03
`H6617` — 'to twist', cluster M10
`H6622` — 'to interpret', cluster M43
...
`H4340` — 'cord', cluster M03
`H4744` — 'assembly', cluster M05
`H4809G` — 'Meribah', cluster M02
...
`H6952` — 'assembly', cluster M05
`H6986` — 'destruction', cluster M10
`H7268` — 'quivering', cluster M01
`H7682` — 'to exalt', cluster M08
...
`H2115` — 'to crush', cluster M24
`H2717B` — 'to destroy', cluster M10
`H3499B` — 'cord', cluster M03
`H3943` — 'to twist', cluster M10
`H4277` — 'to destroy', cluster M10
`H6128` — 'crooked', cluster M14
`H6574` — 'refuse', cluster M27
`H7336` — 'to rule', cluster M23
`H0830H` — 'refuse', cluster M27
`H2416B` — 'kinsfolk', cluster M25
`H2638` — 'lacking', cluster M24
`H4224B` — 'refuge', cluster M19
`H5770` — 'to watch', cluster M30
`H6145` — 'enemy', cluster M44
`H6477` — 'bluntness', cluster M07
`H8138A` — 'to change', cluster M45
`H8213` — 'to abase', cluster M07
`H8549J` — 'unblemished: Thummim', cluster M12
`H0972` — 'chosen', cluster M29
...
`H2559` — 'to turn away', cluster M06
`H7514` — 'to lean', cluster M19
`H0976` — 'testing', cluster M35
`H1421` — 'reviling', cluster M07
`H1998` — 'sound', cluster M13
`H2630` — 'to hoard', cluster M46
`H3271` — 'to cover', cluster M38
`H4654B` — 'ruin', cluster M27
`H4766` — 'abundance', cluster M33
`H4893A` — 'mutilation', cluster M07
`H4923` — 'devastation', cluster M27
`H4926` — 'hearing', cluster M41
`H4937B` — 'support', cluster M19
`H4938A` — 'support', cluster M19
`H5385` — 'burden', cluster M36
`H5448` — 'burden', cluster M36
`H5708` — 'filth', cluster M07
...
`H8383` — 'toil', cluster M03,M36
`H6127` — 'to twist', cluster M10
`H0264` — 'brotherhood', cluster M44
`H2256C` — 'union', cluster M44
`H4614` — 'burden', cluster M36
