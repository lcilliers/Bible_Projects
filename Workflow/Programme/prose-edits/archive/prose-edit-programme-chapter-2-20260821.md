# Prose Edit — Programme — Chapter 2
...
<!-- PROSE_SECTION_ID: 8 -->
<!-- PROSE_SECTION_TYPE: prog_meth_overview -->
<!-- PROSE_BOOK: Programme -->
<!-- PROSE_SECTION: Programme -->
<!-- PROSE_CHAPTER_NO: 2 -->
<!-- PROSE_CHAPTER_TITLE: Research method -->
<!-- PROSE_SORT_ORDER: 9 -->
<!-- PROSE_VERSION: 1 -->
<!-- PROSE_SOURCE_FILE: wa-prose-draft-method-overview-v2-20260421.md -->
...
<!-- PROSE_SECTION_ID: 9 -->
<!-- PROSE_SECTION_TYPE: prog_meth_registry -->
<!-- PROSE_BOOK: Programme -->
<!-- PROSE_SECTION: Programme -->
<!-- PROSE_CHAPTER_NO: 2 -->
<!-- PROSE_CHAPTER_TITLE: Word selection and the registry -->
<!-- PROSE_SORT_ORDER: 10 -->
<!-- PROSE_VERSION: 1 -->
<!-- PROSE_SOURCE_FILE: wa-prose-draft-registry-construction-v2-20260421.md -->
...
<!-- PROSE_SECTION_ID: 10 -->
<!-- PROSE_SECTION_TYPE: prog_meth_flow -->
<!-- PROSE_BOOK: Programme -->
<!-- PROSE_SECTION: Programme -->
<!-- PROSE_CHAPTER_NO: 2 -->
<!-- PROSE_CHAPTER_TITLE: Programme flow -->
<!-- PROSE_SORT_ORDER: 11 -->
<!-- PROSE_VERSION: 1 -->
<!-- PROSE_SOURCE_FILE: wa-prose-draft-programme-flow-v2-20260421.md -->
...
<!-- PROSE_SECTION_ID: 11 -->
<!-- PROSE_SECTION_TYPE: prog_meth_science -->
<!-- PROSE_BOOK: Programme -->
<!-- PROSE_SECTION: Programme -->
<!-- PROSE_CHAPTER_NO: 2 -->
<!-- PROSE_CHAPTER_TITLE: Science in action -->
<!-- PROSE_SORT_ORDER: 12 -->
<!-- PROSE_VERSION: 1 -->
<!-- PROSE_SOURCE_FILE: wa-prose-draft-science-in-action-v3-20260421.md -->
...
<!-- PROSE_SECTION_ID: 12 -->
<!-- PROSE_SECTION_TYPE: prog_meth_publishing -->
<!-- PROSE_BOOK: Programme -->
<!-- PROSE_SECTION: Programme -->
<!-- PROSE_CHAPTER_NO: 2 -->
<!-- PROSE_CHAPTER_TITLE: Publishing -->
<!-- PROSE_SORT_ORDER: 13 -->
<!-- PROSE_VERSION: 1 -->
<!-- PROSE_SOURCE_FILE: wa-prose-draft-publishing-v2-20260421.md -->
...
<!-- PROSE_SECTION_ID: 13 -->
<!-- PROSE_SECTION_TYPE: prog_meth_principles -->
<!-- PROSE_BOOK: Programme -->
<!-- PROSE_SECTION: Programme -->
<!-- PROSE_CHAPTER_NO: 2 -->
<!-- PROSE_CHAPTER_TITLE: Key methodological principles -->
<!-- PROSE_SORT_ORDER: 14 -->
<!-- PROSE_VERSION: 1 -->
<!-- PROSE_SOURCE_FILE: wa-prose-draft-key-principles-v3-20260421.md -->
...
<!-- PROSE_SECTION_ID: 14 -->
<!-- PROSE_SECTION_TYPE: prog_meth_constraints -->
<!-- PROSE_BOOK: Programme -->
<!-- PROSE_SECTION: Programme -->
<!-- PROSE_CHAPTER_NO: 2 -->
<!-- PROSE_CHAPTER_TITLE: Key constraints -->
<!-- PROSE_SORT_ORDER: 15 -->
<!-- PROSE_VERSION: 1 -->
<!-- PROSE_SOURCE_FILE: wa-prose-draft-key-constraints-v3-20260421.md -->
