...
**File:** WA-projection-spec-1.1-2026-07-13.md
**Date:** 2026-07-13
**Version:** 1.1
...
`reading_id, lemma, char_key, ib_char, family, cluster, verse_ref, anchor, same_as, sense, type, source, seat, bearer, operation, target, manner, intensity, specifier, effect, coupling, prohibition, discovery, role, locus`

**Measured: 418 bytes/row → ~856 KB → ~214 k tokens for all 2,048 readings.** It does not need to fit in one pass, and it does not need to. See §0.
