...
The scan in `1377-glossary-fallout-findings-v1-20260902.md` matched against `cfg_column`/`cfg_setting`/
...
|---|---|---|---|
| `Instructions` (current) | 25 | **1** (`wa-verse-analysis-method-v1-20260702.md`) | ~15 (in `1377-glossary-draft-entries-v1-20260902.md`, batch 2) |
| `Instructions` (current) | 24 remaining | 0 | — |
| `Instructions/archive` | 35 | 0 | — |
| `methodology` (+archive) | 121 | 0 | — |
| `Catalogue` (+archive) | 26 | partial — the seed's own Parts 1-4 already mined this folder's `1377-vocabulary-glossary-seed-v2` and its own sources | — |
...
(recorded in `1377-glossary-fallout-findings-v1-20260902.md`'s companion scan is NOT the same list —
