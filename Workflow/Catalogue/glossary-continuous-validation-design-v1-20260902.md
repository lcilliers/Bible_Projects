...
[`glossary-mechanism-design-v1-20260902.md`](glossary-mechanism-design-v1-20260902.md) (still
...
3. **Only if the discussion surfaces a genuinely new or missing Glossary concept** does it become
   ...
   prose CRUD cycle** (`Prose.ps1` export → edit → import, per `glossary-mechanism-design-v1`
