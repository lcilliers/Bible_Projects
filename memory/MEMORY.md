...
- [project_iba_book_by_book_debate_phase](project_iba_book_by_book_debate_phase.md) — ★★ 07-28: NEW MAJOR PHASE — passage-debate every book of the Bible, prophets first then other genres, ~1.5 months. Book 1 Daniel + book 2 Jonah done; check here first for current book-by-book status.
