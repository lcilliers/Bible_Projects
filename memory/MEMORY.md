...
- [project_iba_verse_existence_gated_on_term_discovery](project_iba_verse_existence_gated_on_term_discovery.md) — RESOLVED 07-29: 6.59% of verses missing, accepted as within tolerance; both report steps now note the gap inline + skip.
- [project_iba_configmaint_escalation_self_answered_anomaly](project_iba_configmaint_escalation_self_answered_anomaly.md) — ★ 07-29: UNEXPLAINED — 2 configmaint.propose escalations self-answered 'approve' within ~44s, before a real AnswerRun; no cause found; treat future auto-answers with suspicion.
