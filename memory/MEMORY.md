...
> One line per memory; detail in the topic file. Order: foundational → RESET method → active state → technical/DB → orientation → pre-RESET legacy. Retired v2_x/v3_0 memories are files here but unindexed (recoverable).
...
- [project_verse_fanout_operating_model](project_verse_fanout_operating_model.md) — unit = a VERSE; fan out → digest to OBSERVATIONS; mechanical = substrate.
- [project_inner_being_reading_questions_first](project_inner_being_reading_questions_first.md) — IB meaning INFERRED; surface QUESTIONS first; study = continuing debate.
...
- [feedback_verse_raw_data_must_pull_all_study_evidence](feedback_verse_raw_data_must_pull_all_study_evidence.md) — a verse's RAW data = ALL held evidence, RETRIEVED; reading comes after.
- [feedback_term_coverage_cascade_is_index_not_census](feedback_term_coverage_cascade_is_index_not_census.md) — registry→terms = INDEX not census; registry = seed; span-orphan audit.
...
- [project_RESET_characteristics_to_movements_changeover](project_RESET_characteristics_to_movements_changeover.md) — ★ MILESTONE (2026-06-25): RESET, characteristics→movements; prior lexical + M01-M11 = LEGACY.
...
- [project_superstructure_eisegesis_validation_20260624](project_superstructure_eisegesis_validation_20260624.md) — imported meaning = superstructure; cite a per-verse-VARYING field.
- [project_extended_lexical_model_refinement](project_extended_lexical_model_refinement.md) — refining lexical for reuse → 01b v3; object_type emergent.
...
- [feedback_t2_reference_flag_reclassify](feedback_t2_reference_flag_reclassify.md) — T2 = REFERENCE (qualifier), never standalone. Filter cluster_code='T2'.
...
## Active state
- [project_per_book_corrective_pipeline](project_per_book_corrective_pipeline.md) — ★ LIVE corrective per-book pipeline (a-e); role→gate1→validate. PSALMS 1st book COMPLETE (2026-07-06).
...
- [project_prophets_wisdom_read_at_movement_depth_debt](project_prophets_wisdom_read_at_movement_depth_debt.md) — filed prophet/wisdom readings = MOVEMENT-depth; additive span-depth DEBT.
- [project_poetic_chapter_driven_method](project_poetic_chapter_driven_method.md) — poetic chapter-driven; Phase1 per-verse + Phase2 whole-chapter. ★ PSALTER COMPLETE (399+419-548).
- [project_cross_chapter_synthesis_per_characteristic](project_cross_chapter_synthesis_per_characteristic.md) — NEXT: cross-chapter summary PER CHARACTERISTIC (emergent); re-align first.
- [project_lexical_prose_endpoint_and_ve_lexical_phase1](project_lexical_prose_endpoint_and_ve_lexical_phase1.md) — per-term endpoint = story ('lexical_prose'). ve_lexical Phase1 (M63, 3.37.0); Phase2 held.
...
- [project_m10_family_status_primary_logical_units](project_m10_family_status_primary_logical_units.md) — M10 family = STATUS-primary, 32 logical-units; next = §10.
...
- [project_faculty_not_gripped_audit_20260624](project_faculty_not_gripped_audit_20260624.md) — faculty audit (mostly superseded by the reset).
- [project_next_action_audit_surface_verses](project_next_action_audit_surface_verses.md) — audit expansion for verse-meaning quality.
- [project_pointer_lifecycle_model](project_pointer_lifecycle_model.md) — pointers route to clusters, validated → findings.
- [project_session_d_moot](project_session_d_moot.md) — Session D won't run; pointers → findings.
...
- [project_ve_lexical_normalisation_and_groundings](project_ve_lexical_normalisation_and_groundings.md) — (stale) VE normalised into ve_lexical; mti_terms unique/owned.
...
- [project_reconstruction_baseline_20260614](project_reconstruction_baseline_20260614.md) — 2026-06-14 reconstruction = authoritative current-state (01-04).
...
<!-- pre-RESET legacy, files retained/recoverable (demoted from index 2026-07-05 for size): feedback_setaside_verses_inform_word_meaning, feedback_external_pole_not_inner_state, feedback_span_pairing_and_reciprocal_findings, project_meaning_duplicates_then_fabricates, feedback_boundary_resolution_required, feedback_findings_marginal_value, feedback_coverage_flags_philosophy, feedback_route_dual_cluster_findings, feedback_cross_cluster_co_occurrence, feedback_re_examination_workflow, feedback_remediation_is_analysis_not_reassignment, feedback_interdependent_clusters_finalise_together, feedback_emergent_aggregate_questions, feedback_qualifier_routes_per_verse_occurrence, feedback_transitive_faculty_verb_is_qualifier, feedback_ontology_typed_relationships, feedback_faculty_must_be_per_term_not_per_cluster, feedback_patch_format, feedback_version_discipline -->
