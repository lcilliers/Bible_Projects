...
**RECURRED 2026-06-28 (ruthlessness investigation).** Same mistake: across one investigation I spawned four docs (exclusion finding → add-plan → triage → existence-findings), each partially superseding the last, none closed — "you keep creating new documents, not closing off previously wrong documents… jumping all over the place… this review is a mess." Fix applied: consolidated into ONE living doc `research/investigations/wa-ruthlessness-investigation.md` (with a §6 decision log + §7 superseded-list), archived the four. **Rule going forward: an investigation/review = ONE living doc from the start, with a decision log; new findings update it in place; reversed decisions are struck in the log, not left as separate live docs the researcher must re-read.**
