...
description: "ACTIVE WORK (2026-07-05): reading the OT NARRATIVES for the inner being at SPAN DEPTH (verse-first, span-by-span, gate-checked). GENESIS 1-50 FULLY COMPLETE (69 readings ps 916-1004, 4 syntheses). EXODUS Block 1 (1:1-15:21) COMPLETE (20 readings ps 968-987) + Block 2 (15:22-24:18) COMPLETE (10 readings ps 1005-1014, synthesis). NEXT: Exodus Block 4 (golden calf 32-34, narrative-rich - the next GEM); Blocks 3+5 (tabernacle 25-31, 35-40) THIN."
metadata: 
  node_type: memory
  type: project
...
- Backfill needed (Ex was 793/1213; backfilled 1-24 via STEP). Exodus text NOT complete beyond ch24 - Blocks 3-5 need backfill (STEP must be up).
...
- Exodus block plan (5 blocks): 1 done (1-15:21); 2 DONE (15:22-24:18); 3 tabernacle-instructions THIN (25-31); 4 golden calf+renewal (32-34, narrative-rich - NEXT GEM); 5 tabernacle-construction THIN (35-40). Block plan + density scan: `verse-analysis/exodus/_seg/wa-exodus-passage-set-block1-*` + `_reports/wa-exodus-density-readiness-scan-*`.
...
**NEXT (resume here): Exodus Block 4, Ex 32-34 (golden calf + covenant renewal)** - the next narrative GEM (Blocks 3+5 tabernacle 25-31/35-40 are THIN - decide whether to read at reduced depth or a single summary reading). Watch in Block 4: the covenant vow "we will do" (24:7) BROKEN at the calf (the trust-that-won't-hold arc lands); Moses' intercession (the mediator standing in the breach); God's self-revelation "compassionate and gracious" (34:6 - the channun of 22:27 now fully sounded); Aaron's interior (the calf-making excuse); the anger (Moses smashing the tablets). Backfill Ex 32-34 first (STEP up - Exodus text was 793/1213, ch1-24 now backfilled). Exodus block plan in `verse-analysis/exodus/_seg/wa-exodus-passage-set-block1-*`.
