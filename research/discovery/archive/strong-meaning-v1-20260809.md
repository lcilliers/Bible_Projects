...
- `strong` rows: **9184**
- with a `strong_sense` row: **9184** (100%)
- with a `strong_meaning_tree` row: **8580** (93%)
- with lexicon detail (`lsj`/`mounce`): **5637** (61%)
...
**Total: 9184** (5637 with some lexicon detail + 3547 with none = 9184).
