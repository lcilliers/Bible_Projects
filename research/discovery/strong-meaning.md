...
- `strong` rows: **3635**
- with a `strong_sense` row: **3635** (100%)
- with a `strong_meaning_tree` row: **3336** (92%)
- with lexicon detail (`lsj`/`mounce`): **1506** (41%)
...
**Total: 3635** (1506 with some lexicon detail + 2129 with none = 3635).
