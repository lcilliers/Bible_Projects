...
**Filename:** verse-lexical-enrichment-checklist-v1-20260902.md
**Escalation:** #1379
**Status:** PROTOTYPE — being test-driven against Ps 25:2 and Hos 2:4
(`Workflow/Catalogue/verse-lexical-enrichment-applied-ps25-2-hos2-4-v1-20260902.md`) before any
...
glossary — M-code cluster/tier labels, see `verse-lexical-enrichment-scope-v1-20260902.md` §7) or
