...
> Generated 2026-09-18T09:58:27Z by `report.batch_progress`.

- currently running: **0**
- committed (this view): **0**
- failed (this view): **0**
- total spend (this view): **$0.0000**
...
0 running, 0 committed, 0 failed (view limited to the most recent 500 rows unless filtered)
