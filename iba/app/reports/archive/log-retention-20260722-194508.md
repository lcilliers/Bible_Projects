...
> Generated 2026-07-22T06:01:24Z. Read-only visibility — no rows deleted or archived here. A retention/deletion POLICY is a separate decision; this report exists so that decision can be made with real numbers, not a guess.

## Summary

- `run`: **765** rows, oldest 2026-07-18T02:36:15Z, newest 2026-07-22T06:00:21Z
  - done: 315
  - running: 181
  - paused: 179
  - failed: 90
- `escalation`: **220** rows — 3 open (raised), 217 answered
- `validation_result`: **15460** rows, oldest 2026-07-18T02:36:19Z
...
| --- | --- | --- | --- | --- | --- |
| 169 | RUN-20260718_153740_699-NEW-WORD | blindness (spiritual | registry.create | Register the new word 'blindness (spiritual'? | 2026-07-18T14:37:41Z |
