...
> Generated 2026-07-22T18:39:28Z. Read-only. Candidate (L4b) + passages. Sections shown are config-governed (`cfg_setting validation.show_*`).
...
- [1. App & DB](#1-app-db)
- [3. Candidate (L4b)](#3-candidate-l4b)
...
| ⚠ WARN | candidate missing registry words (double control) | informational | 9 lemma(s) | candidate lemmas no registry word carries — grow the registry |
## 4. Passages
...
| ⚠ WARN | candidate_seed.tag (pattern:candidate.tag_clean_pattern, programme-wide) | 0 violations | 225/1733 | see candidate-quality.md for detail |
