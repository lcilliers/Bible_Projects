...
| generated_at | 2026-08-11T16:55:37Z |
...
1. GOVERNANCE.md was last modified 2026-08-09T09:06:19Z, before the newest applied cfg_change_detail row (2026-08-11T16:55:37Z) — check whether that change needs an entry (GOVERNANCE.md §8's own rule)
...
| --- | --- | --- | --- | --- |
| _(none)_ | _(none)_ | _(none)_ | _(none)_ | _(none)_ |
CSV pairing: `cluster`; `cluster_strong` (joined to strong.stepGloss/language and cluster.short_name)
