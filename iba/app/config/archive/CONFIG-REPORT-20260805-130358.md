...
| generated_at | 2026-08-05T12:02:44Z |
...
8. iba/app/lib/spanreading.py has no cfg_utility row — run migration/bootstrap_cfg_utility.py to register it
...
**24** registered module(s) — **12** declared `config_exempt` (a legitimate zero for config-setting/enum usage, not a completeness gap), **0** inactive (module removed/merged). See §0 "Low config-density utilities" for any NON-exempt module still flagged.
