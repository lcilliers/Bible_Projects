...
| generated_at | 2026-07-22T19:32:58Z |
...
**Orphan configs** (12) — a `cfg_setting`/`cfg_enum` not referenced by any code:
- cfg_setting 'governance.build_md_on_code_change'
- cfg_setting 'governance.governance_md_on_rule_change'
- cfg_setting 'notification.header_run_id'
- cfg_setting 'notification.header_runs_over'
- cfg_setting 'notification.header_step'
- cfg_setting 'notification.header_work_package'
- cfg_setting 'notification.not_initialised'
- cfg_setting 'notification.paused_banner_guided'
- cfg_setting 'notification.paused_banner_passthrough'
- cfg_setting 'notification.step_result_line'
- cfg_setting 'notification.stopped_banner'
