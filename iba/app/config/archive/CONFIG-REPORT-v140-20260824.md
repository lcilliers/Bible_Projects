...
| generated_at | 2026-08-24T17:03:22Z |
...
8. GOVERNANCE.md was last modified 2026-08-24T10:01:19Z, before the newest applied cfg_change_detail row (2026-08-24T17:03:21Z) — check whether that change needs an entry (GOVERNANCE.md §8's own rule)
...
**408** registered module(s) — **28** declared `config_exempt` (a legitimate zero for config-setting/enum usage, not a completeness gap), **357** inactive (module removed/merged). See §0 "Low config-density utilities" for any NON-exempt module still flagged.
