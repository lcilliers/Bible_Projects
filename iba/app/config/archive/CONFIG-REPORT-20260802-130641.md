...
| generated_at | 2026-08-02T12:06:38Z |
...
1. GOVERNANCE.md was last modified 2026-07-30T10:56:33Z, before the newest applied cfg_change_detail row (2026-08-02T12:06:38Z) — check whether that change needs an entry (GOVERNANCE.md §8's own rule)
...
**Inactive configs** (369 row(s) across 10 table(s)) — deactivated, not deleted; excluded from validation above. 355 from the candidate-system retraction, 2026-07-23 (GOVERNANCE.md §15D; migration/retract_candidate_system.py); 13 from the passage-system retirement, 2026-07-26 (reports/archive/passage-system-retirement-record-20260726.md); **1 UNATTRIBUTED** (not part of a known retirement — needs a look): cfg_work_package.verse-analysis-report.
...
- **cfg_work_package** (7): `build-passages`, `candidate-curation`, `candidate-quality`, `passage-debate-report`, `seed-candidate-report`, `set-candidates`, `verse-analysis-report`
