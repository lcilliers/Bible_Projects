...
| generated_at | 2026-08-15T14:15:40Z |
...
**Unregistered lib modules** (3) — iba/app/lib/*.py with no cfg_utility row:
1. iba/app/lib/clusterassign.py has no cfg_utility row — run migration/bootstrap_cfg_utility.py to register it
2. iba/app/lib/clusterreport.py has no cfg_utility row — run migration/bootstrap_cfg_utility.py to register it
3. iba/app/lib/strongreconcile.py has no cfg_utility row — run migration/bootstrap_cfg_utility.py to register it
...
**30** registered module(s) — **14** declared `config_exempt` (a legitimate zero for config-setting/enum usage, not a completeness gap), **0** inactive (module removed/merged). See §0 "Low config-density utilities" for any NON-exempt module still flagged.
