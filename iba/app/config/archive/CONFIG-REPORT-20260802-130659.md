...
| generated_at | 2026-08-02T12:06:57Z |
...
4. GOVERNANCE.md was last modified 2026-07-30T10:56:33Z, before the newest applied cfg_change_detail row (2026-08-02T12:06:56Z) — check whether that change needs an entry (GOVERNANCE.md §8's own rule)
...
**Inactive configs** (372 row(s) across 10 table(s)) — deactivated, not deleted; excluded from validation above. 355 from the candidate-system retraction, 2026-07-23 (GOVERNANCE.md §15D; migration/retract_candidate_system.py); 13 from the passage-system retirement, 2026-07-26 (reports/archive/passage-system-retirement-record-20260726.md); **4 UNATTRIBUTED** (not part of a known retirement — needs a look): cfg_step.verse-analysis-report/report.verse_span_meaning, cfg_work_package.book-narrative-generate, cfg_work_package.book-narrative-validate, cfg_work_package.verse-analysis-report.
...
- **cfg_step** (8): `build-passages/passage.build`, `candidate-curation/candidate.curate`, `candidate-curation/candidate.load`, `candidate-quality/candidate.validate`, `seed-candidate-report/report.seed_candidate`, `set-candidates/candidate.seed`, `set-candidates/candidate.set`, `verse-analysis-report/report.verse_span_meaning`
