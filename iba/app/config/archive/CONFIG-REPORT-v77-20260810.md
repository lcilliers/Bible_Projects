...
| generated_at | 2026-08-10T06:13:17Z |
...
1. GOVERNANCE.md was last modified 2026-08-09T09:06:19Z, before the newest applied cfg_change_detail row (2026-08-10T06:13:16Z) — check whether that change needs an entry (GOVERNANCE.md §8's own rule)

**Unregistered lib modules** (1) — iba/app/lib/*.py with no cfg_utility row:
2. iba/app/lib/strongversereport.py has no cfg_utility row — run migration/bootstrap_cfg_utility.py to register it
