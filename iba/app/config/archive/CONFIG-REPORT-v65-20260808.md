...
| generated_at | 2026-08-08T05:54:06Z |
...
1. GOVERNANCE.md was last modified 2026-08-08T05:35:58Z, before the newest applied cfg_change_detail row (2026-08-08T05:54:06Z) — check whether that change needs an entry (GOVERNANCE.md §8's own rule)
...
**27** registered module(s) — **13** declared `config_exempt` (a legitimate zero for config-setting/enum usage, not a completeness gap), **0** inactive (module removed/merged). See §0 "Low config-density utilities" for any NON-exempt module still flagged.
