...
| generated_at | 2026-08-11T16:27:05Z |
...
1. GOVERNANCE.md was last modified 2026-08-09T09:06:19Z, before the newest applied cfg_change_detail row (2026-08-11T16:27:05Z) — check whether that change needs an entry (GOVERNANCE.md §8's own rule)
...
CSV pairing: `strong` (the raw table this report analyzes for its coverage check); `strong_lsj_parsed`; `strong_meaning_parsed`; `strong_mounce_parsed`; `strong_related`
