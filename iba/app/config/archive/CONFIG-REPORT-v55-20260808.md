...
| generated_at | 2026-08-08T05:05:54Z |
...
1. GOVERNANCE.md was last modified 2026-08-07T16:11:38Z, before the newest applied cfg_change_detail row (2026-08-08T05:05:54Z) — check whether that change needs an entry (GOVERNANCE.md §8's own rule)

**Unregistered lib modules** (1) — iba/app/lib/*.py with no cfg_utility row:
2. iba/app/lib/debateaudit.py has no cfg_utility row — run migration/bootstrap_cfg_utility.py to register it
...
**26** registered module(s) — **12** declared `config_exempt` (a legitimate zero for config-setting/enum usage, not a completeness gap), **0** inactive (module removed/merged). See §0 "Low config-density utilities" for any NON-exempt module still flagged.
